...
-- 		local id, name, points, completed, month, day, year, description, flags, image, rewardText, isGuild, wasEarnedByMe, earnedBy = GetAchievementInfo(object.Achievements[i].ID)
-- 		if completed and not chkBox1:GetChecked() then
-- 			if chkBox2:GetChecked() and wasEarnedByMe then --ignore it
-- 			else
-- 				RaidAchFilter:AchAdd(maxID, object.Achievements[i].ID, indent)
-- 				maxID=maxID+1
-- 				indent=indent-75
-- 			end
