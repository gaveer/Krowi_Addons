...
-- 4.0
Xpack_Cata_Raid_BH = Xpack_Cata_Raids:AddChild(KrowiAF.AchievementCategory:New(AF_CATEGORY_RAID_BH));
Xpack_Cata_Raid_BH:AddAchievementIDs({5416}); -- Defeat X
Xpack_Cata_Raid_BWD = Xpack_Cata_Raids:AddChild(KrowiAF.AchievementCategory:New(AF_CATEGORY_RAID_BWD));
...
Xpack_Cata_Raid_BoT = Xpack_Cata_Raids:AddChild(KrowiAF.AchievementCategory:New(AF_CATEGORY_RAID_BOT));
...
Xpack_Cata_Raid_TotFW = Xpack_Cata_Raids:AddChild(KrowiAF.AchievementCategory:New(AF_CATEGORY_RAID_TOTFW));
...
Xpack_Cata_Raid_FL = Xpack_Cata_Raids:AddChild(KrowiAF.AchievementCategory:New(AF_CATEGORY_RAID_FL));
...
Xpack_Cata_Raid_DS = Xpack_Cata_Raids:AddChild(KrowiAF.AchievementCategory:New(AF_CATEGORY_RAID_DS));
