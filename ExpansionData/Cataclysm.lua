-- Expansion
Xpack_Cata = AchievementFilter.AchievementCategory:New(AF_CATEGORY_CATA);
tinsert(AchievementFilter.Data, Xpack_Cata);

-- Raids
Xpack_Cata_Raids = Xpack_Cata:AddChild(AchievementFilter.AchievementCategory:New(AF_CATEGORY_RAIDS));

-- 4.0
Xpack_Cata_Raid_BH = Xpack_Cata_Raids:AddChild(AchievementFilter.AchievementCategory:New(AF_CATEGORY_RAID_BH));
-- Xpack_Cata_Raid_BH:AddAchievementIDs({5416}); -- Defeat X
Xpack_Cata_Raid_BWD = Xpack_Cata_Raids:AddChild(AchievementFilter.AchievementCategory:New(AF_CATEGORY_RAID_BWD));
...
-- Xpack_Cata_Raid_BoT = Xpack_Cata_Raids:AddChild(AchievementFilter.AchievementCategory:New(AF_CATEGORY_RAID_BOT));
...
-- Xpack_Cata_Raid_BoT:AddAchievement(5313, AchievementFilter.AchievementType.FoS, false); -- Feats of Strength (Unobtainable)
-- Xpack_Cata_Raid_TotFW = Xpack_Cata_Raids:AddChild(AchievementFilter.AchievementCategory:New(AF_CATEGORY_RAID_TOTFW));
...
-- Xpack_Cata_Raid_FL = Xpack_Cata_Raids:AddChild(AchievementFilter.AchievementCategory:New(AF_CATEGORY_RAID_FL));
...
-- Xpack_Cata_Raid_DS = Xpack_Cata_Raids:AddChild(AchievementFilter.AchievementCategory:New(AF_CATEGORY_RAID_DS));
...
-- Dungeons
Xpack_Cata_Dungeons = Xpack_Cata:AddChild(AchievementFilter.AchievementCategory:New(AF_CATEGORY_DUNGEONS));
Xpack_Cata_Placeholder1 = Xpack_Cata_Dungeons:AddChild(AchievementFilter.AchievementCategory:New("Placeholder1"));
Xpack_Cata_Placeholder2 = Xpack_Cata_Placeholder1:AddChild(AchievementFilter.AchievementCategory:New("Placeholder2"));