-- Expansion
Xpack_Cata = AchievementFilter.AchievementCategory:New("Cataclysm");
tinsert(AchievementFilter.Data, Xpack_Cata);

-- Raids
Xpack_Cata_Raids = Xpack_Cata:AddChild(AchievementFilter.AchievementCategory:New("Raids"));

-- 4.0
Xpack_Cata_Raid_BH = Xpack_Cata_Raids:AddChild(AchievementFilter.AchievementCategory:New("Baradin Hold"));
Xpack_Cata_Raid_BH:AddAchievementIDs({5416}); -- Defeat X
Xpack_Cata_Raid_BWD = Xpack_Cata_Raids:AddChild(AchievementFilter.AchievementCategory:New("Blackwing Descent"));
...
Xpack_Cata_Raid_BoT = Xpack_Cata_Raids:AddChild(AchievementFilter.AchievementCategory:New("Bastion of Twilight"));
...
Xpack_Cata_Raid_TotFW = Xpack_Cata_Raids:AddChild(AchievementFilter.AchievementCategory:New("Throne of the Four Winds"));
...
Xpack_Cata_Raid_FL = Xpack_Cata_Raids:AddChild(AchievementFilter.AchievementCategory:New("Firelands"));
...
Xpack_Cata_Raid_DS = Xpack_Cata_Raids:AddChild(AchievementFilter.AchievementCategory:New("Dragon Soul"));
