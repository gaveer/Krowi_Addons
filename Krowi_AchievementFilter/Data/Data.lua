...
data.CategoriesExpansions, data.CategoriesEvents, data.CategoriesPvP = {}, {}, {};
...
function data.Load()
    ...
    data.CategoriesExpansions, data.CategoriesEvents, data.CategoriesPvP, data.CurrentZoneCategory, data.SelectedZoneCategory, data.FocusedCategory, data.ExcludedCategory, data.NextPatchCategory = data.ExportedCategories.Load(data.Achievements);
