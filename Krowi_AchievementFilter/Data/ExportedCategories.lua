...
function exportedCategories.Load(a)
    ...
    tmp[687] = cat:New(C_Map.GetMapInfo(13).name); -- Eastern Kingdoms
    ...
    tmp[1033] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[653] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[672] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[688] = cat:New(C_Map.GetMapInfo(12).name); -- Kalimdor
    ...
    tmp[705] = cat:New(C_Map.GetMapInfo(10).name); -- Northern Barrens
    ...
    tmp[706] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[692] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[714] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[5] = cat:New((EJ_GetInstanceInfo(226))); -- Ragefire Chasm
    AddC(tmp[2], tmp[5]);
    ...
    tmp[11] = cat:New((EJ_GetInstanceInfo(238))); -- The Stockade
    AddC(tmp[2], tmp[11]);
    ...
    tmp[14] = cat:New((EJ_GetInstanceInfo(234))); -- Razorfen Downs
    AddC(tmp[2], tmp[14]);
    AddA(tmp[14], a[636]); -- Razorfen Downs
    tmp[17] = cat:New((EJ_GetInstanceInfo(239))); -- Uldaman
    AddC(tmp[2], tmp[17]);
    AddA(tmp[17], a[638]); -- Uldaman
    tmp[18] = cat:New((EJ_GetInstanceInfo(241))); -- Zul'Farrak
    AddC(tmp[2], tmp[18]);
    AddA(tmp[18], a[639]); -- Zul'Farrak
    tmp[19] = cat:New((EJ_GetInstanceInfo(232))); -- Maraudon
    AddC(tmp[2], tmp[19]);
    AddA(tmp[19], a[640]); -- Maraudon
    tmp[20] = cat:New((EJ_GetInstanceInfo(237))); -- The Temple Of Atal'hakkar
    AddC(tmp[2], tmp[20]);
    AddA(tmp[20], a[641]); -- Sunken Temple
    tmp[21] = cat:New((EJ_GetInstanceInfo(228))); -- Blackrock Depths
    AddC(tmp[2], tmp[21]);
    ...
    tmp[797] = cat:New((EJ_GetInstanceInfo(559)) .. " (" .. (GetCategoryInfo(15234)) .. ")"); -- Upper Blackrock Spire
    AddC(tmp[2], tmp[797]);
    AddA(tmp[797], a[1307]); -- Upper Blackrock Spire (Classic)
    AddA(tmp[797], a[2188]); -- Leeeeeeeeeeeeeroy!
    tmp[23] = cat:New((EJ_GetInstanceInfo(230))); -- Dire Maul
    AddC(tmp[2], tmp[23]);
    AddA(tmp[23], a[644]); -- King of Dire Maul
    AddA(tmp[23], a[5788]); -- Agent of the Shen'dralar
    tmp[25] = cat:New((EJ_GetInstanceInfo(236))); -- Stratholme
    AddC(tmp[2], tmp[25]);
    ...
    tmp[7] = cat:New((EJ_GetInstanceInfo(741))); -- Molten Core
    AddC(tmp[3], tmp[7]);
    ...
    tmp[779] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[7], tmp[779]);
    AddA(tmp[779], a[955]); -- Hydraxian Waterlords
    AddA(tmp[779], a[2496]); -- The Fifth Element
    tmp[26] = cat:New((EJ_GetInstanceInfo(760)) .. " (" .. (GetCategoryInfo(15234)) .. ")"); -- Onyxia's Lair
    AddC(tmp[3], tmp[26]);
    AddA(tmp[26], a[684]); -- Onyxia's Lair (Level 60)
    AddA(tmp[26], a[9924]); -- Field Photographer
    tmp[27] = cat:New((EJ_GetInstanceInfo(742))); -- Blackwing Lair
    AddC(tmp[3], tmp[27]);
    AddA(tmp[27], a[685]); -- Blackwing Lair
    AddA(tmp[27], a[11742]); -- Dress in Lairs
    AddA(tmp[27], a[7934]); -- Raiding with Leashes
    tmp[28] = cat:New((EJ_GetInstanceInfo(76)) .. " (" .. (GetCategoryInfo(15234)) .. ")"); -- Zul'Gurub
    AddC(tmp[3], tmp[28]);
    ...
    tmp[789] = cat:New((GetCategoryInfo(15273))); -- Reputation
    AddC(tmp[28], tmp[789]);
    AddA(tmp[789], a[957]); -- Hero of the Zandalar Tribe
    tmp[29] = cat:New((EJ_GetInstanceInfo(743))); -- Ruins of Ahn'Qiraj
    AddC(tmp[3], tmp[29]);
    AddA(tmp[29], a[689]); -- Ruins of Ahn'Qiraj
    tmp[784] = cat:New((GetCategoryInfo(15273))); -- Reputation
    AddC(tmp[29], tmp[784]);
    AddA(tmp[784], a[953]); -- Guardian of Cenarius
    tmp[30] = cat:New((EJ_GetInstanceInfo(744))); -- Temple of Ahn'Qiraj
    AddC(tmp[3], tmp[30]);
    ...
    tmp[780] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[30], tmp[780]);
    ...
    tmp[632] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[619] = cat:New(C_Map.GetMapInfo(108).name); -- Terokkar Forest
    AddC(tmp[616], tmp[619]);
    tmp[626] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[633] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    AddC(tmp[619], tmp[633]);
    AddA(tmp[633], a[867]); -- Explore Terokkar Forest
    tmp[642] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[619], tmp[642]);
    AddA(tmp[642], a[903]); -- Shattrath Divided
    AddA(tmp[642], a[1205]); -- Hero of Shattrath
    tmp[620] = cat:New(C_Map.GetMapInfo(107).name); -- Nagrand
    AddC(tmp[616], tmp[620]);
    tmp[627] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[634] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    AddC(tmp[620], tmp[634]);
    AddA(tmp[634], a[866]); -- Explore Nagrand
    tmp[641] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    ...
    tmp[647] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[74], tmp[647]);
    AddA(tmp[647], a[960]); -- The Violet Eye
    tmp[75] = cat:New((EJ_GetInstanceInfo(746))); -- Gruul's Lair
    AddC(tmp[73], tmp[75]);
    AddA(tmp[75], a[692]); -- Gruul's Lair
    AddA(tmp[75], a[11746]); -- Outlandish Style
    tmp[76] = cat:New((EJ_GetInstanceInfo(747))); -- Magtheridon's Lair
    AddC(tmp[73], tmp[76]);
    AddA(tmp[76], a[693]); -- Magtheridon's Lair
    AddA(tmp[76], a[11746]); -- Outlandish Style
    tmp[77] = cat:New((EJ_GetInstanceInfo(748))); -- Serpentshrine Cavern
    AddC(tmp[73], tmp[77]);
    ...
    tmp[78] = cat:New((EJ_GetInstanceInfo(749))); -- The Eye
    AddC(tmp[73], tmp[78]);
    ...
    tmp[79] = cat:New((EJ_GetInstanceInfo(750))); -- The Battle for Mount Hyjal
    AddC(tmp[73], tmp[79]);
    AddA(tmp[79], a[695]); -- The Battle for Mount Hyjal
    AddA(tmp[79], a[9824]); -- Raiding with Leashes III: Drinkin' From the Sunwell
    tmp[646] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[79], tmp[646]);
    AddA(tmp[646], a[959]); -- The Scale of the Sands
    tmp[80] = cat:New((EJ_GetInstanceInfo(751))); -- Black Temple
    AddC(tmp[73], tmp[80]);
    ...
    tmp[645] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[80], tmp[645]);
    AddA(tmp[645], a[958]); -- Sworn to the Deathsworn
    tmp[81] = cat:New((EJ_GetInstanceInfo(77)) .. " (" .. (GetCategoryInfo(15234)) .. ")"); -- Zul'Aman
    AddC(tmp[73], tmp[81]);
    AddA(tmp[81], a[691]); -- Zul'Aman
    AddA(tmp[81], a[430]); -- Amani War Bear
    tmp[82] = cat:New((EJ_GetInstanceInfo(752))); -- Sunwell Plateau
    AddC(tmp[73], tmp[82]);
    ...
    tmp[786] = cat:New((GetCategoryInfo(15117))); -- Pet Battles
    AddC(tmp[55], tmp[786]);
    ...
    tmp[578] = cat:New(C_Map.GetMapInfo(114).name); -- Borean Tundra
    AddC(tmp[577], tmp[578]);
    tmp[586] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[587] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    AddC(tmp[578], tmp[587]);
    AddA(tmp[587], a[1264]); -- Explore Borean Tundra
    tmp[588] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[578], tmp[588]);
    AddA(tmp[588], a[949]); -- Tuskarrmageddon
    tmp[579] = cat:New(C_Map.GetMapInfo(117).name); -- Howling Fjord
    AddC(tmp[577], tmp[579]);
    tmp[589] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    AddC(tmp[579], tmp[589]);
    AddA(tmp[589], a[34]); -- I've Toured the Fjord
    AddA(tmp[589], a[1356]); -- I've Toured the Fjord
    tmp[590] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[580] = cat:New(C_Map.GetMapInfo(115).name); -- Dragonblight
    AddC(tmp[577], tmp[580]);
    tmp[592] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[599] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    AddC(tmp[582], tmp[599]);
    AddA(tmp[599], a[1267]); -- Explore Zul'Drak
    tmp[583] = cat:New(C_Map.GetMapInfo(119).name); -- Sholazar Basin
    AddC(tmp[577], tmp[583]);
    tmp[601] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[602] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    AddC(tmp[583], tmp[602]);
    AddA(tmp[602], a[1268]); -- Explore Sholazar Basin
    tmp[603] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    ...
    tmp[88] = cat:New((EJ_GetInstanceInfo(272))); -- Azjol-Nerub
    AddC(tmp[84], tmp[88]);
    ...
    tmp[89] = cat:New((EJ_GetInstanceInfo(271))); -- Ahn'kahet: The Old Kingdom
    AddC(tmp[84], tmp[89]);
    ...
    tmp[90] = cat:New((EJ_GetInstanceInfo(273))); -- Drak'Tharon Keep
    AddC(tmp[84], tmp[90]);
    ...
    tmp[91] = cat:New((EJ_GetInstanceInfo(283))); -- The Violet Hold
    AddC(tmp[84], tmp[91]);
    ...
    tmp[92] = cat:New((EJ_GetInstanceInfo(274))); -- Gundrak
    AddC(tmp[84], tmp[92]);
    ...
    tmp[93] = cat:New((EJ_GetInstanceInfo(277))); -- Halls of Stone
    AddC(tmp[84], tmp[93]);
    ...
    tmp[94] = cat:New((EJ_GetInstanceInfo(275))); -- Halls of Lightning
    AddC(tmp[84], tmp[94]);
    ...
    tmp[95] = cat:New((EJ_GetInstanceInfo(282))); -- The Oculus
    AddC(tmp[84], tmp[95]);
    ...
    tmp[97] = cat:New((EJ_GetInstanceInfo(286))); -- Utgarde Pinnacle
    AddC(tmp[84], tmp[97]);
    ...
    tmp[96] = cat:New((EJ_GetInstanceInfo(279))); -- The Culling of Stratholme
    AddC(tmp[84], tmp[96]);
    ...
    tmp[98] = cat:New((EJ_GetInstanceInfo(284))); -- Trial of the Champion
    AddC(tmp[84], tmp[98]);
    ...
    tmp[99] = cat:New((EJ_GetInstanceInfo(280))); -- The Forge of Souls
    AddC(tmp[84], tmp[99]);
    ...
    tmp[100] = cat:New((EJ_GetInstanceInfo(278))); -- Pit of Saron
    AddC(tmp[84], tmp[100]);
    ...
    tmp[101] = cat:New((EJ_GetInstanceInfo(276))); -- Halls of Reflection
    AddC(tmp[84], tmp[101]);
    ...
    tmp[85] = cat:New((GetCategoryInfo(15271))); -- Raids
    AddC(tmp[83], tmp[85]);
    ...
    tmp[102] = cat:New((EJ_GetInstanceInfo(753))); -- Vault of Archavon
    AddC(tmp[85], tmp[102]);
    ...
    tmp[105] = cat:New((EJ_GetInstanceInfo(754))); -- Naxxramas
    AddC(tmp[85], tmp[105]);
    ...
    tmp[108] = cat:New((EJ_GetInstanceInfo(755))); -- The Obsidian Sanctum
    AddC(tmp[85], tmp[108]);
    ...
    tmp[111] = cat:New((EJ_GetInstanceInfo(756))); -- The Eye of Eternity
    AddC(tmp[85], tmp[111]);
    ...
    tmp[114] = cat:New((EJ_GetInstanceInfo(759))); -- Ulduar
    AddC(tmp[85], tmp[114]);
    ...
    tmp[115] = cat:New((GetDifficultyInfo(3)) .. " (" .. (GetCategoryInfo(15234)) .. ")"); -- Ulduar 10
    ...
    tmp[116] = cat:New((GetDifficultyInfo(4)) .. " (" .. (GetCategoryInfo(15234)) .. ")"); -- Ulduar 25
    ...
    tmp[117] = cat:New((EJ_GetInstanceInfo(757))); -- Trial of the Crusader
    AddC(tmp[85], tmp[117]);
    ...
    tmp[120] = cat:New((EJ_GetInstanceInfo(760))); -- Onyxia's Lair
    AddC(tmp[85], tmp[120]);
    ...
    tmp[123] = cat:New((EJ_GetInstanceInfo(758))); -- Icecrown Citadel
    AddC(tmp[85], tmp[123]);
    ...
    tmp[615] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[123], tmp[615]);
    AddA(tmp[615], a[4598]); -- The Ashen Verdict
    tmp[126] = cat:New((EJ_GetInstanceInfo(761))); -- The Ruby Sanctum
    AddC(tmp[85], tmp[126]);
    ...
    tmp[787] = cat:New((GetCategoryInfo(15117))); -- Pet Battles
    AddC(tmp[83], tmp[787]);
    ...
    tmp[551] = cat:New(C_Map.GetMapInfo(203).name); -- Vashj'ir
    AddC(tmp[550], tmp[551]);
    tmp[557] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[564] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[552] = cat:New(C_Map.GetMapInfo(198).name); -- Mount Hyjal
    AddC(tmp[550], tmp[552]);
    tmp[558] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[565] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    AddC(tmp[552], tmp[565]);
    AddA(tmp[565], a[4863]); -- Explore Hyjal
    AddA(tmp[565], a[9924]); -- Field Photographer
    tmp[571] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[552], tmp[571]);
    AddA(tmp[571], a[4882]); -- The Guardians of Hyjal
    tmp[553] = cat:New(C_Map.GetMapInfo(207).name); -- Deepholm
    AddC(tmp[550], tmp[553]);
    tmp[559] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[567] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    AddC(tmp[554], tmp[567]);
    AddA(tmp[567], a[4865]); -- Explore Uldum
    tmp[574] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[554], tmp[574]);
    AddA(tmp[574], a[4884]); -- Ramkahen
    tmp[555] = cat:New(C_Map.GetMapInfo(241).name); -- Twilight Highlands
    AddC(tmp[550], tmp[555]);
    tmp[561] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[568] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[130] = cat:New((GetCategoryInfo(15272))); -- Dungeons
    ...
    tmp[132] = cat:New((EJ_GetInstanceInfo(66))); -- Blackrock Caverns
    ...
    tmp[133] = cat:New((EJ_GetInstanceInfo(65))); -- Throne of the Tides
    ...
    tmp[134] = cat:New((EJ_GetInstanceInfo(67))); -- The Stonecore
    ...
    tmp[135] = cat:New((EJ_GetInstanceInfo(68))); -- The Vortex Pinnacle
    ...
    tmp[136] = cat:New((EJ_GetInstanceInfo(71))); -- Grim Batol
    ...
    tmp[137] = cat:New((EJ_GetInstanceInfo(70))); -- Halls of Origination
    ...
    tmp[138] = cat:New((EJ_GetInstanceInfo(69))); -- Lost City of the Tol'vir
    ...
    tmp[139] = cat:New((EJ_GetInstanceInfo(63))); -- Deadmines
    ...
    tmp[140] = cat:New((EJ_GetInstanceInfo(64))); -- Shadowfang Keep
    ...
    tmp[142] = cat:New((EJ_GetInstanceInfo(77))); -- Zul'Aman
    ...
    tmp[145] = cat:New((EJ_GetInstanceInfo(186))); -- Hour of Twilight
    AddC(tmp[130], tmp[145]);
    AddA(tmp[145], a[6132]); -- Eclipse
    AddA(tmp[145], a[6119]); -- Heroic: Hour of Twilight
    tmp[131] = cat:New((GetCategoryInfo(15271))); -- Raids
    ...
    tmp[146] = cat:New((EJ_GetInstanceInfo(75))); -- Baradin Hold
    ...
    tmp[563] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[569] = cat:New((GetCategoryInfo(15270)), true); -- PvP
    ...
    tmp[575] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    ...
    tmp[527] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[529] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    ...
    tmp[492] = cat:New(C_Map.GetMapInfo(371).name); -- The Jade Forest
    AddC(tmp[491], tmp[492]);
    tmp[519] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[545] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    AddC(tmp[492], tmp[545]);
    AddA(tmp[545], a[6351]); -- Explore Jade Forest
    AddA(tmp[545], a[7381]); -- Restore Balance
    tmp[546] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[492], tmp[546]);
    AddA(tmp[546], a[6550]); -- Order of the Cloud Serpent
    tmp[493] = cat:New(C_Map.GetMapInfo(376).name); -- Valley of the Four Winds
    AddC(tmp[491], tmp[493]);
    AddA(tmp[493], a[6517]); -- Extinction Event
    tmp[516] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[494] = cat:New(C_Map.GetMapInfo(418).name); -- Krasarang Wilds
    AddC(tmp[491], tmp[494]);
    tmp[513] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[542] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    AddC(tmp[495], tmp[542]);
    AddA(tmp[542], a[6976]); -- Explore Kun-Lai Summit
    AddA(tmp[542], a[9924]); -- Field Photographer
    tmp[496] = cat:New(C_Map.GetMapInfo(388).name); -- Townlong Steppes
    AddC(tmp[491], tmp[496]);
    tmp[507] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[540] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    AddC(tmp[496], tmp[540]);
    AddA(tmp[540], a[6977]); -- Explore Townlong Steppes
    tmp[541] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[496], tmp[541]);
    AddA(tmp[541], a[6366]); -- Shado-Pan
    tmp[497] = cat:New(C_Map.GetMapInfo(422).name); -- Dread Wastes
    AddC(tmp[491], tmp[497]);
    tmp[504] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[538] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    AddC(tmp[497], tmp[538]);
    AddA(tmp[538], a[6978]); -- Explore Dread Wastes
    AddA(tmp[538], a[6857]); -- Heart of the Mantid Swarm
    tmp[539] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[497], tmp[539]);
    AddA(tmp[539], a[6545]); -- Klaxxi
    AddA(tmp[539], a[8023]); -- Wakener
    tmp[498] = cat:New(C_Map.GetMapInfo(390).name); -- Vale of Eternal Blossoms
    AddC(tmp[491], tmp[498]);
    tmp[501] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[522] = cat:New(C_Map.GetMapInfo(504).name); -- Isle of Thunder
    AddC(tmp[491], tmp[522]);
    AddA(tmp[522], a[8028]); -- Praise the Sun!
    tmp[523] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[524] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[525] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    ...
    tmp[530] = cat:New(C_Map.GetMapInfo(554).name); -- Timeless Isle
    AddC(tmp[491], tmp[530]);
    AddA(tmp[530], a[8535]); -- Celestial Challenge
    AddA(tmp[530], a[8533]); -- Ordos
    tmp[531] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[535] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[530], tmp[535]);
    AddA(tmp[535], a[8715]); -- Emperor Shaohao
    tmp[190] = cat:New((GetCategoryInfo(15272))); -- Dungeons
    ...
    tmp[193] = cat:New((EJ_GetInstanceInfo(313))); -- Temple of the Jade Serpent
    ...
    tmp[194] = cat:New((EJ_GetInstanceInfo(302))); -- Stormstout Brewery
    ...
    tmp[195] = cat:New((EJ_GetInstanceInfo(321))); -- Mogu'shan Palace
    ...
    tmp[196] = cat:New((EJ_GetInstanceInfo(312))); -- Shado-Pan Monastery
    ...
    tmp[197] = cat:New((EJ_GetInstanceInfo(303))); -- Gate of the Setting Sun
    ...
    tmp[198] = cat:New((EJ_GetInstanceInfo(324))); -- Siege of Niuzao Temple
    ...
    tmp[199] = cat:New((EJ_GetInstanceInfo(311))); -- Scarlet Halls
    ...
    tmp[200] = cat:New((EJ_GetInstanceInfo(316))); -- Scarlet Monastery
    ...
    tmp[201] = cat:New((EJ_GetInstanceInfo(246))); -- Scholomance
    ...
    tmp[191] = cat:New((GetCategoryInfo(15271))); -- Raids
    ...
    tmp[207] = cat:New((GetLFGDungeonInfo(517))); -- A Brewing Storm
    ...
    tmp[499] = cat:New((GetLFGDungeonInfo(589))); -- A Little Patience
    ...
    tmp[208] = cat:New((GetLFGDungeonInfo(511))); -- Arena of Annihilation
    ...
    tmp[214] = cat:New((GetLFGDungeonInfo(593))); -- Assault on Zan'vess
    AddC(tmp[192], tmp[214]);
    AddA(tmp[214], a[8016]); -- Assault on Zan'vess
    AddA(tmp[214], a[8017]); -- For the Swarm
    tmp[220] = cat:New((GetLFGDungeonInfo(646))); -- Blood in the Snow
    ...
    tmp[209] = cat:New((GetLFGDungeonInfo(539))); -- Brewmoon Festival
    ...
    tmp[210] = cat:New((GetLFGDungeonInfo(504))); -- Crypt of Forgotten Kings
    ...
    tmp[215] = cat:New((GetLFGDungeonInfo(616))); -- Dagger in the Dark
    ...
    tmp[221] = cat:New((GetLFGDungeonInfo(647))); -- Dark Heart of Pandaria
    ...
    tmp[218] = cat:New((GetLFGDungeonInfo(595))); -- Domination Point
    ...
    tmp[211] = cat:New((GetLFGDungeonInfo(492))); -- Greenstone Village
    ...
    tmp[216] = cat:New((GetLFGDungeonInfo(590))); -- Lion's Landing
    ...
    tmp[500] = cat:New(C_Map.GetMapInfo(417).name .. " (" .. (GetCategoryInfo(15234)) .. ")"); -- Temple of Kotmogu
    ...
    tmp[222] = cat:New((GetLFGDungeonInfo(649))); -- The Secrets of Ragefire
    ...
    tmp[212] = cat:New((GetLFGDungeonInfo(566))); -- Theramore's Fall
    ...
    tmp[213] = cat:New((GetLFGDungeonInfo(499))); -- Unga Ingoo
    ...
    tmp[219] = cat:New((GetLFGDungeonInfo(655))); -- Battle on the High Seas
    ...
    tmp[490] = cat:New((GetCategoryInfo(15222))); -- Proving Grounds
    ...
    tmp[486] = cat:New(C_Map.GetMapInfo(572).name); -- Draenor
    AddC(tmp[449], tmp[486]);
    AddA(tmp[486], a[10053]); -- I Found Pepe!
    tmp[487] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[488] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[489] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[486], tmp[489]);
    AddA(tmp[489], a[9477]); -- Savage Friends
    AddA(tmp[489], a[9478]); -- Savage Friends
    tmp[450] = cat:New(C_Map.GetMapInfo(539).name); -- Shadowmoon Valley
    AddC(tmp[449], tmp[450]);
    tmp[457] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[458] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    AddC(tmp[450], tmp[458]);
    AddA(tmp[458], a[8938]); -- Explore Shadowmoon Valley
    AddA(tmp[458], a[9924]); -- Field Photographer
    tmp[460] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[450], tmp[460]);
    AddA(tmp[460], a[9470]); -- Council of Exarchs
    tmp[451] = cat:New(C_Map.GetMapInfo(525).name); -- Frostfire Ridge
    AddC(tmp[449], tmp[451]);
    tmp[461] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[462] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    AddC(tmp[451], tmp[462]);
    AddA(tmp[462], a[8937]); -- Explore Frostfire Ridge
    tmp[464] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[451], tmp[464]);
    AddA(tmp[464], a[9471]); -- Frostwolf Orcs
    tmp[452] = cat:New(C_Map.GetMapInfo(543).name); -- Gorgrond
    AddC(tmp[449], tmp[452]);
    AddA(tmp[452], a[9423]); -- Goliaths of Gorgrond
    tmp[465] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[466] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[468] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[452], tmp[468]);
    AddA(tmp[468], a[9475]); -- Laughing Skull Orcs
    tmp[453] = cat:New(C_Map.GetMapInfo(535).name); -- Talador
    AddC(tmp[449], tmp[453]);
    tmp[469] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[470] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    AddC(tmp[453], tmp[470]);
    AddA(tmp[470], a[8940]); -- Explore Talador
    tmp[472] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[453], tmp[472]);
    AddA(tmp[472], a[9476]); -- Sha'tari Defense
    tmp[454] = cat:New(C_Map.GetMapInfo(542).name); -- Spires of Arak
    AddC(tmp[449], tmp[454]);
    AddA(tmp[454], a[9425]); -- So Grossly Incandescent
    tmp[473] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[474] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    AddC(tmp[454], tmp[474]);
    AddA(tmp[474], a[8941]); -- Explore Spires of Arak
    tmp[476] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[454], tmp[476]);
    AddA(tmp[476], a[9469]); -- Arakkoa Outcasts
    AddA(tmp[476], a[9072]); -- Mantle of the Talon King
    tmp[455] = cat:New(C_Map.GetMapInfo(550).name); -- Nagrand
    AddC(tmp[449], tmp[455]);
    tmp[477] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[482] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[484] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[456], tmp[484]);
    AddA(tmp[484], a[10349]); -- Tanaan Diplomat
    AddA(tmp[484], a[10350]); -- Tanaan Diplomat
    tmp[224] = cat:New((GetCategoryInfo(15272))); -- Dungeons
    ...
    tmp[226] = cat:New((EJ_GetInstanceInfo(385))); -- Bloodmaul Slag Mines
    ...
    tmp[227] = cat:New((EJ_GetInstanceInfo(558))); -- Iron Docks
    ...
    tmp[228] = cat:New((EJ_GetInstanceInfo(547))); -- Auchindoun
    ...
    tmp[229] = cat:New((EJ_GetInstanceInfo(476))); -- Skyreach
    ...
    tmp[230] = cat:New((EJ_GetInstanceInfo(536))); -- Grimrail Depot
    ...
    tmp[231] = cat:New((EJ_GetInstanceInfo(556))); -- The Everbloom
    ...
    tmp[232] = cat:New((EJ_GetInstanceInfo(537))); -- Shadowmoon Burial Grounds
    ...
    tmp[233] = cat:New((EJ_GetInstanceInfo(559))); -- Upper Blackrock Spire
    ...
    tmp[225] = cat:New((GetCategoryInfo(15271))); -- Raids
    ...
    tmp[485] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[397] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[398] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[413] = cat:New((GetCategoryInfo(15270)), true); -- PvP
    AddC(tmp[396], tmp[413]);
    AddA(tmp[413], a[11474]); -- "Free For All, More For Me"
    tmp[414] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    ...
    tmp[382] = cat:New(C_Map.GetMapInfo(626).name); -- Dalaran
    AddC(tmp[381], tmp[382]);
    AddA(tmp[382], a[10770]); -- The Tangerine Traveler
    tmp[383] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[405] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    AddC(tmp[382], tmp[405]);
    AddA(tmp[405], a[11066]); -- Underbelly Tycoon
    tmp[384] = cat:New(C_Map.GetMapInfo(630).name); -- Azsuna
    AddC(tmp[381], tmp[384]);
    tmp[385] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    AddC(tmp[384], tmp[385]);
    AddA(tmp[385], a[10763]); -- Azsuna Matata
    tmp[399] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[412] = cat:New((GetCategoryInfo(15270)), true); -- PvP
    AddC(tmp[384], tmp[412]);
    AddA(tmp[412], a[11475]); -- Mission Accomplished
    tmp[387] = cat:New(C_Map.GetMapInfo(641).name); -- Val'sharah
    AddC(tmp[381], tmp[387]);
    tmp[391] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    AddC(tmp[387], tmp[391]);
    AddA(tmp[391], a[10698]); -- That's Val'sharah Folks!
    tmp[400] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[411] = cat:New((GetCategoryInfo(15270)), true); -- PvP
    AddC(tmp[387], tmp[411]);
    AddA(tmp[411], a[11477]); -- Off the Top Rook
    tmp[388] = cat:New(C_Map.GetMapInfo(650).name); -- Highmountain
    AddC(tmp[381], tmp[388]);
    tmp[392] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[401] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[410] = cat:New((GetCategoryInfo(15270)), true); -- PvP
    AddC(tmp[388], tmp[410]);
    AddA(tmp[410], a[11478]); -- The Darkbrul-oh
    tmp[416] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[388], tmp[416]);
    AddA(tmp[416], a[12292]); -- Highmountain Tribe
    tmp[386] = cat:New(C_Map.GetMapInfo(634).name); -- Stormheim
    AddC(tmp[381], tmp[386]);
    tmp[390] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[402] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[409] = cat:New((GetCategoryInfo(15270)), true); -- PvP
    AddC(tmp[386], tmp[409]);
    AddA(tmp[409], a[11476]); -- Saddle Sore
    tmp[389] = cat:New(C_Map.GetMapInfo(680).name); -- Suramar
    AddC(tmp[381], tmp[389]);
    tmp[393] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[403] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[415] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[389], tmp[415]);
    AddA(tmp[415], a[10778]); -- The Nightfallen
    tmp[394] = cat:New(C_Map.GetMapInfo(646).name); -- Broken Shore
    AddC(tmp[381], tmp[394]);
    AddA(tmp[394], a[11786]); -- Terrors of the Shore
    tmp[395] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[404] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[241] = cat:New((EJ_GetInstanceInfo(762))); -- Darkheart Thicket
    ...
    tmp[242] = cat:New((EJ_GetInstanceInfo(721))); -- Halls of Valor
    ...
    tmp[243] = cat:New((EJ_GetInstanceInfo(767))); -- Neltharions Lair
    ...
    tmp[244] = cat:New((EJ_GetInstanceInfo(777))); -- Assault on Violet Hold
    ...
    tmp[245] = cat:New((EJ_GetInstanceInfo(707))); -- Vault of the Wardens
    ...
    tmp[246] = cat:New((EJ_GetInstanceInfo(740))); -- Black Rook Hold
    ...
    tmp[247] = cat:New((EJ_GetInstanceInfo(727))); -- Maw of Souls
    ...
    tmp[248] = cat:New((EJ_GetInstanceInfo(726))); -- The Arcway
    ...
    tmp[249] = cat:New((EJ_GetInstanceInfo(800))); -- Court of Stars
    ...
    tmp[250] = cat:New((EJ_GetInstanceInfo(860))); -- Return to Karazhan
    ...
    tmp[251] = cat:New((EJ_GetInstanceInfo(900))); -- Cathedral of Eternal Night
    ...
    tmp[252] = cat:New((EJ_GetInstanceInfo(945))); -- Seat of the Triumvirate
    ...
    tmp[239] = cat:New((GetCategoryInfo(15271))); -- Raids
    ...
    tmp[253] = cat:New((EJ_GetInstanceInfo(768))); -- The Emerald Nightmare
    ...
    tmp[254] = cat:New((EJ_GetInstanceInfo(786))); -- The Nighthold
    ...
    tmp[255] = cat:New((EJ_GetInstanceInfo(861))); -- Trial of Valor
    ...
    tmp[256] = cat:New((EJ_GetInstanceInfo(875))); -- Tomb of Sargeras
    ...
    tmp[257] = cat:New((EJ_GetInstanceInfo(946))); -- Antorus, the Burning Throne
    ...
    tmp[430] = cat:New((GetCategoryInfo(15117))); -- Pet Battles
    ...
    tmp[272] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[273] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[274] = cat:New((GetCategoryInfo(15270)), true); -- PvP
    ...
    tmp[275] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    ...
    tmp[276] = cat:New(C_Map.GetMapInfo(895).name); -- Tiragarde Sound
    AddC(tmp[259], tmp[276]);
    tmp[281] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[278] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[279] = cat:New((GetCategoryInfo(15270)), true); -- PvP
    AddC(tmp[276], tmp[279]);
    AddA(tmp[279], a[12577]); -- Tour of Duty: Tiragarde Sound
    tmp[280] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[276], tmp[280]);
    AddA(tmp[280], a[12951]); -- Proudmoore Admiralty
    AddA(tmp[280], a[12954]); -- Champion of the 7th Legion
    tmp[282] = cat:New(C_Map.GetMapInfo(896).name); -- Drustvar
    AddC(tmp[259], tmp[282]);
    tmp[283] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    AddC(tmp[282], tmp[283]);
    AddA(tmp[283], a[12497]); -- Drust Do It.
    tmp[284] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[285] = cat:New((GetCategoryInfo(15270)), true); -- PvP
    AddC(tmp[282], tmp[285]);
    AddA(tmp[285], a[12579]); -- Tour of Duty: Drustvar
    tmp[286] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[282], tmp[286]);
    AddA(tmp[286], a[12952]); -- Order of Embers
    tmp[287] = cat:New(C_Map.GetMapInfo(942).name); -- Stormsong Valley
    AddC(tmp[259], tmp[287]);
    tmp[288] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[289] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[290] = cat:New((GetCategoryInfo(15270)), true); -- PvP
    AddC(tmp[287], tmp[290]);
    AddA(tmp[290], a[12578]); -- Tour of Duty: Stormsong Valley
    tmp[291] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[287], tmp[291]);
    AddA(tmp[291], a[12953]); -- Storm's Wake
    tmp[292] = cat:New(C_Map.GetMapInfo(862).name); -- Zuldazar
    AddC(tmp[259], tmp[292]);
    tmp[293] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[294] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[295] = cat:New((GetCategoryInfo(15270)), true); -- PvP
    ...
    tmp[296] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[292], tmp[296]);
    AddA(tmp[296], a[12950]); -- Zandalari Empire
    AddA(tmp[296], a[12957]); -- Champion of the Honorbound
    tmp[297] = cat:New(C_Map.GetMapInfo(863).name); -- Nazmir
    AddC(tmp[259], tmp[297]);
    tmp[298] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[299] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[300] = cat:New((GetCategoryInfo(15270)), true); -- PvP
    AddC(tmp[297], tmp[300]);
    AddA(tmp[300], a[12574]); -- Tour of Duty: Nazmir
    tmp[301] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[297], tmp[301]);
    AddA(tmp[301], a[12948]); -- Talanji's Expedition
    tmp[302] = cat:New(C_Map.GetMapInfo(864).name); -- Vol'dun
    AddC(tmp[259], tmp[302]);
    tmp[303] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[304] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[305] = cat:New((GetCategoryInfo(15270)), true); -- PvP
    AddC(tmp[302], tmp[305]);
    AddA(tmp[305], a[12576]); -- Tour of Duty: Vol'dun
    tmp[306] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    ...
    tmp[309] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[311] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[307], tmp[311]);
    AddA(tmp[311], a[13557]); -- Rustbolt Rebellion
    tmp[312] = cat:New(C_Map.GetMapInfo(1355).name); -- Nazjatar
    AddC(tmp[259], tmp[312]);
    tmp[313] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    AddC(tmp[312], tmp[313]);
    AddA(tmp[313], a[13710]); -- Sunken Ambitions
    AddA(tmp[313], a[13709]); -- Unfathomable
    tmp[314] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[315] = cat:New((GetCategoryInfo(15270)), true); -- PvP
    ...
    tmp[316] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[312], tmp[316]);
    AddA(tmp[316], a[13558]); -- Waveblade Ankoan
    AddA(tmp[316], a[13559]); -- The Unshackled
    tmp[317] = cat:New(C_Map.GetMapInfo(1530).name); -- Vale of Eternal Blossoms
    AddC(tmp[259], tmp[317]);
    tmp[318] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    AddC(tmp[317], tmp[318]);
    AddA(tmp[318], a[14154]); -- Defend the Vale
    AddA(tmp[318], a[14161]); -- All Consuming
    tmp[447] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[321] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[317], tmp[321]);
    AddA(tmp[321], a[14156]); -- The Rajani
    tmp[322] = cat:New(C_Map.GetMapInfo(1527).name); -- Uldum
    AddC(tmp[259], tmp[322]);
    tmp[323] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    AddC(tmp[322], tmp[323]);
    AddA(tmp[323], a[14153]); -- Uldum Under Assault
    AddA(tmp[323], a[14161]); -- All Consuming
    tmp[448] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[324] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[322], tmp[324]);
    AddA(tmp[324], a[14155]); -- Uldum Accord
    tmp[325] = cat:New((GetCategoryInfo(15272))); -- Dungeons
    ...
    tmp[327] = cat:New((EJ_GetInstanceInfo(1001))); -- Freelhold
    ...
    tmp[328] = cat:New((EJ_GetInstanceInfo(1021))); -- Waycrest Manor
    ...
    tmp[329] = cat:New((EJ_GetInstanceInfo(1036))); -- Shrine of the Storm
    ...
    tmp[330] = cat:New((EJ_GetInstanceInfo(968))); -- Atal'Dazar
    ...
    tmp[331] = cat:New((EJ_GetInstanceInfo(1022))); -- The Underrot
    ...
    tmp[332] = cat:New((EJ_GetInstanceInfo(1030))); -- Temple of Sethraliss
    ...
    tmp[333] = cat:New((EJ_GetInstanceInfo(1002))); -- Tol Dagor
    ...
    tmp[334] = cat:New((EJ_GetInstanceInfo(1012))); -- The MOTHERLODE!!
    ...
    tmp[335] = cat:New((EJ_GetInstanceInfo(1023))); -- Siege of Boralus
    ...
    tmp[336] = cat:New((EJ_GetInstanceInfo(1041))); -- Kings' Rest
    ...
    tmp[337] = cat:New((EJ_GetInstanceInfo(1178))); -- Operation: Mechagon
    ...
    tmp[326] = cat:New((GetCategoryInfo(15271))); -- Raids
    ...
    tmp[338] = cat:New((EJ_GetInstanceInfo(1031))); -- Uldir
    ...
    tmp[339] = cat:New((EJ_GetInstanceInfo(1176))); -- Battle of Dazar'alor
    ...
    tmp[340] = cat:New((EJ_GetInstanceInfo(1177))); -- Crucible of Storms
    ...
    tmp[341] = cat:New((EJ_GetInstanceInfo(1179))); -- The Eternal Palace
    ...
    tmp[342] = cat:New((EJ_GetInstanceInfo(1180))); -- Ny'alotha, the Waking City
    ...
    tmp[343] = cat:New((GetCategoryInfo(15117))); -- Pet Battles
    ...
    tmp[425] = cat:New((GetCategoryInfo(15307))); -- Island Expeditions
    ...
    tmp[436] = cat:New((GetLFGDungeonInfo(1687))); -- Un'gol Ruins
    ...
    tmp[437] = cat:New((GetLFGDungeonInfo(1734))); -- The Dread Chain
    ...
    tmp[438] = cat:New((GetLFGDungeonInfo(1723))); -- The Rotting Mire
    ...
    tmp[439] = cat:New((GetLFGDungeonInfo(1750))); -- The Molten Cay
    ...
    tmp[440] = cat:New((GetLFGDungeonInfo(1724))); -- Verdant Wilds
    ...
    tmp[441] = cat:New((GetLFGDungeonInfo(1725))); -- Skittering Hollow
    ...
    tmp[442] = cat:New((GetLFGDungeonInfo(1735))); -- The Whispering Reef
    ...
    tmp[443] = cat:New((GetLFGDungeonInfo(1932))); -- Jorundall
    ...
    tmp[444] = cat:New((GetLFGDungeonInfo(1928))); -- Havenswood
    ...
    tmp[445] = cat:New((GetLFGDungeonInfo(1984))); -- Crestfall
    ...
    tmp[446] = cat:New((GetLFGDungeonInfo(1983))); -- Snowblossom Village
    ...
    tmp[426] = cat:New((GetCategoryInfo(15308))); -- War Effort
    ...
    tmp[434] = cat:New((GetLFGDungeonInfo(1615))); -- Battle for Stromgarde
    ...
    tmp[435] = cat:New((GetLFGDungeonInfo(1901))); -- The Battle for Darkshore
    ...
    tmp[427] = cat:New((GetCategoryInfo(15417))); -- Heart of Azeroth
    ...
    tmp[428] = cat:New((GetCategoryInfo(15426))); -- Visions of N'Zoth
    ...
    tmp[345] = cat:New(C_Map.GetMapInfo(1533).name); -- Bastion
    AddC(tmp[344], tmp[345]);
    tmp[346] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[347] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[348] = cat:New((GetCategoryInfo(15270)), true); -- PvP
    AddC(tmp[345], tmp[348]);
    AddA(tmp[348], a[14514]); -- Tour of Duty: Bastion
    tmp[349] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[345], tmp[349]);
    AddA(tmp[349], a[14335]); -- The Ascended
    tmp[350] = cat:New(C_Map.GetMapInfo(1536).name); -- Maldraxxus
    AddC(tmp[344], tmp[350]);
    tmp[351] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    AddC(tmp[350], tmp[351]);
    AddA(tmp[351], a[14206]); -- Blade of the Primus
    AddA(tmp[351], a[14799]); -- Sojourner of Maldraxxus
    tmp[352] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[353] = cat:New((GetCategoryInfo(15270)), true); -- PvP
    AddC(tmp[350], tmp[353]);
    AddA(tmp[353], a[14513]); -- Tour of Duty: Maldraxxus
    tmp[354] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[350], tmp[354]);
    AddA(tmp[354], a[14336]); -- Undying Army
    tmp[355] = cat:New(C_Map.GetMapInfo(1565).name); -- Ardenweald
    AddC(tmp[344], tmp[355]);
    tmp[356] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[357] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[358] = cat:New((GetCategoryInfo(15270)), true); -- PvP
    AddC(tmp[355], tmp[358]);
    AddA(tmp[358], a[14511]); -- Tour of Duty: Ardenweald
    tmp[359] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[355], tmp[359]);
    AddA(tmp[359], a[14337]); -- The Wild Hunt
    tmp[360] = cat:New(C_Map.GetMapInfo(1525).name); -- Revendreth
    AddC(tmp[344], tmp[360]);
    tmp[361] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[362] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[363] = cat:New((GetCategoryInfo(15270)), true); -- PvP
    AddC(tmp[360], tmp[363]);
    AddA(tmp[363], a[14512]); -- Tour of Duty: Revendreth
    tmp[364] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    AddC(tmp[360], tmp[364]);
    AddA(tmp[364], a[14338]); -- Court of Harvesters
    tmp[365] = cat:New(C_Map.GetMapInfo(1543).name); -- The Maw
    AddC(tmp[344], tmp[365]);
    tmp[366] = cat:New((GetCategoryInfo(15447)), true); -- Quests
    ...
    tmp[367] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[818] = cat:New((GetCategoryInfo(97)), true); -- Exploration
    ...
    tmp[813] = cat:New((GetCategoryInfo(15273)), true); -- Reputation
    ...
    tmp[371] = cat:New((EJ_GetInstanceInfo(1182))); -- The Necrotic Wake
    ...
    tmp[372] = cat:New((EJ_GetInstanceInfo(1183))); -- Plaguefall
    ...
    tmp[373] = cat:New((EJ_GetInstanceInfo(1184))); -- Mists of Tirna Scithe
    ...
    tmp[374] = cat:New((EJ_GetInstanceInfo(1185))); -- Halls of Atonement
    ...
    tmp[375] = cat:New((EJ_GetInstanceInfo(1186))); -- Spires of Ascension
    ...
    tmp[376] = cat:New((EJ_GetInstanceInfo(1187))); -- Theater of Pain
    ...
    tmp[377] = cat:New((EJ_GetInstanceInfo(1188))); -- De Other Side
    ...
    tmp[378] = cat:New((EJ_GetInstanceInfo(1189))); -- Sanguine Depths
    ...
    tmp[370] = cat:New((GetCategoryInfo(15271))); -- Raids
    AddC(tmp[6], tmp[370]);
    AddA(tmp[370], a[14355]); -- Glory of the Nathria Raider
    AddA(tmp[370], a[15130]); -- Glory of the Dominant Raider
    tmp[379] = cat:New((EJ_GetInstanceInfo(1190))); -- Castle Nathria
    ...
    tmp[424] = cat:New((GetCategoryInfo(15440))); -- Torghast
    AddC(tmp[6], tmp[424]);
    ...
    tmp[423] = cat:New(C_Covenants.GetCovenantData(1).name); -- Kyrian
    ...
    tmp[421] = cat:New(C_Covenants.GetCovenantData(2).name); -- Venthyr
    ...
    tmp[422] = cat:New(C_Covenants.GetCovenantData(3).name); -- Night Fae
    ...
    tmp[420] = cat:New(C_Covenants.GetCovenantData(4).name); -- Necrolord
    ...
    tmp[955].IsTab = true;
    local tabPvPCategories = tmp[955];
    tmp[960] = cat:New((GetCategoryInfo(14801))); -- Alterac Valley
    AddC(tmp[955], tmp[960]);
    ...
    tmp[961] = cat:New((GetCategoryInfo(15414))); -- Ashran
    AddC(tmp[955], tmp[961]);
    ...
    tmp[964] = cat:New((GetCategoryInfo(15073))); -- Battle for Gilneas
    AddC(tmp[955], tmp[964]);
    ...
    tmp[957] = cat:New((GetCategoryInfo(15218))); -- Deepwind Gorge
    AddC(tmp[955], tmp[957]);
    ...
    tmp[959] = cat:New((GetCategoryInfo(14803))); -- Eye of the Storm
    AddC(tmp[955], tmp[959]);
    ...
    tmp[962] = cat:New((GetCategoryInfo(15003))); -- Isle of Conquest
    AddC(tmp[955], tmp[962]);
    ...
    tmp[968] = cat:New((GetCategoryInfo(15292))); -- Seething Shore
    AddC(tmp[955], tmp[968]);
    ...
    tmp[966] = cat:New((GetCategoryInfo(15162))); -- Silvershard Mines
    AddC(tmp[955], tmp[966]);
    ...
    tmp[965] = cat:New((GetCategoryInfo(15074))); -- Twin Peaks
    AddC(tmp[955], tmp[965]);
    ...
    tmp[958] = cat:New((GetCategoryInfo(14804))); -- Warsong Gulch
    AddC(tmp[955], tmp[958]);
    ...
    tmp[963] = cat:New((GetCategoryInfo(14901))); -- Wintergrasp
    AddC(tmp[955], tmp[963]);
