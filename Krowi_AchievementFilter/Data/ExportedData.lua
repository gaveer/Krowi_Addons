-- [[ Exported at 2021-03-14 22-02-52 ]] --
...
function exportedData.Load(categories, achievements)
    ...
    local tmpCategories = {};
    tmpCategories[433] = InsertAndReturn(categories, achievementCategory:New(addon.L["Current Zone"], nil)); -- Current Zone
    tmpCategories[433].AlwaysVisible = true;
    tmpCategories[433].HasFlexibleData = true;
    local currentZoneCategory = tmpCategories[433];
    tmpCategories[1] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(14864), nil)); -- Classic
    tmpCategories[2] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15272), nil)); -- Dungeons
    ...
    tmpCategories[4] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(63), nil)); -- Deadmines
    ...
    tmpCategories[5] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(226), nil)); -- Ragefire Chasm
    ...
    tmpCategories[8] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(240), nil)); -- Wailing Caverns
    ...
    tmpCategories[9] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(64), nil)); -- Shadowfang Keep
    ...
    tmpCategories[10] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(227), nil)); -- Blackfathom Deeps
    ...
    tmpCategories[11] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(238), nil)); -- The Stockade
    ...
    tmpCategories[12] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(231), nil)); -- Gnomeregan
    ...
    tmpCategories[13] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(233), nil)); -- Razorfen Kraul
    ...
    tmpCategories[14] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(234), nil)); -- Razorfen Downs
    ...
    tmpCategories[15] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(311), nil)); -- Scarlet Halls
    ...
    tmpCategories[16] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(316), nil)); -- Scarlet Monastery
    ...
    tmpCategories[17] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(239), nil)); -- Uldaman
    ...
    tmpCategories[18] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(241), nil)); -- Zul'Farrak
    ...
    tmpCategories[19] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(232), nil)); -- Maraudon
    ...
    tmpCategories[20] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(237), nil)); -- The Temple Of Atal'hakkar
    ...
    tmpCategories[21] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(228), nil)); -- Blackrock Depths
    ...
    tmpCategories[22] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(229), nil)); -- Lower Blackrock Spire
    ...
    tmpCategories[23] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(230), nil)); -- Dire Maul
    ...
    tmpCategories[24] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(246), nil)); -- Scholomance
    ...
    tmpCategories[25] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(236), nil)); -- Stratholme
    ...
    tmpCategories[3] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15271), nil)); -- Raids
    ...
    tmpCategories[7] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(741), nil)); -- Molten Core
    ...
    tmpCategories[26] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(760) .. " (" .. GetCategoryInfo(15234) .. ")", nil)); -- Onyxia's Lair (Legacy)
    ...
    tmpCategories[27] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(742), nil)); -- Blackwing Lair
    ...
    tmpCategories[28] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(76) .. " (" .. GetCategoryInfo(15234) .. ")", nil)); -- Zul'Gurub (Legacy)
    ...
    tmpCategories[29] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(743), nil)); -- Ruins of Ahn'Qiraj
    ...
    tmpCategories[30] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(744), nil)); -- Temple of Ahn'Qiraj
    ...
    tmpCategories[55] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(14865), nil)); -- The Burning Crusade
    tmpCategories[56] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15272), nil)); -- Dungeons
    ...
    tmpCategories[57] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(248), nil)); -- Hellfire Ramparts
    ...
    tmpCategories[58] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(256), nil)); -- The Blood Furnace
    ...
    tmpCategories[59] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(259), nil)); -- The Shattered Halls
    ...
    tmpCategories[60] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(260), nil)); -- The Slave Pens
    ...
    tmpCategories[61] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(262), nil)); -- The Underbog
    ...
    tmpCategories[62] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(261), nil)); -- The Steamvault
    ...
    tmpCategories[63] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(250), nil)); -- Mana-Tombs
    ...
    tmpCategories[64] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(247), nil)); -- Auchenai Crypts
    ...
    tmpCategories[65] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(252), nil)); -- Sethekk Halls
    ...
    tmpCategories[66] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(253), nil)); -- Shadow Labyrinth
    ...
    tmpCategories[67] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(251), nil)); -- Old Hillsbrad Foothills
    ...
    tmpCategories[68] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(255), nil)); -- The Black Morass
    ...
    tmpCategories[69] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(258), nil)); -- The Mechanar
    ...
    tmpCategories[70] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(257), nil)); -- The Botanica
    ...
    tmpCategories[71] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(254), nil)); -- The Arcatraz
    ...
    tmpCategories[72] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(249), nil)); -- Magisters Terrace
    ...
    tmpCategories[73] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15271), nil)); -- Raids
    ...
    tmpCategories[74] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(745), nil)); -- Karazhan
    ...
    tmpCategories[75] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(746), nil)); -- Gruul's Lair
    ...
    tmpCategories[76] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(747), nil)); -- Magtheridon's Lair
    ...
    tmpCategories[77] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(748), nil)); -- Serpentshrine Cavern
    ...
    tmpCategories[78] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(749), nil)); -- The Eye
    ...
    tmpCategories[79] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(750), nil)); -- The Battle for Mount Hyjal
    ...
    tmpCategories[80] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(751), nil)); -- Black Temple
    ...
    tmpCategories[81] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(77) .. " (" .. GetCategoryInfo(15234) .. ")", nil)); -- Zul'Aman
    ...
    tmpCategories[82] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(752), nil)); -- Sunwell Plateau
    ...
    tmpCategories[83] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(14866), nil)); -- Wrath of the Lich King
    tmpCategories[84] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15272), nil)); -- Dungeons
    ...
    tmpCategories[86] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(285), nil)); -- Utgarde Keep
    ...
    tmpCategories[87] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(281), nil)); -- The Nexus
    ...
    tmpCategories[88] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(272), nil)); -- Azjol-Nerub
    ...
    tmpCategories[89] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(271), nil)); -- Ahn'kahet: The Old Kingdom
    ...
    tmpCategories[90] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(273), nil)); -- Drak'Tharon Keep
    ...
    tmpCategories[91] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(283), nil)); -- The Violet Hold
    ...
    tmpCategories[92] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(274), nil)); -- Gundrak
    ...
    tmpCategories[93] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(277), nil)); -- Halls of Stone
    ...
    tmpCategories[94] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(275), nil)); -- Halls of Lightning
    ...
    tmpCategories[95] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(282), nil)); -- The Oculus
    ...
    tmpCategories[97] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(286), nil)); -- Utgarde Pinnacle
    ...
    tmpCategories[96] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(279), nil)); -- The Culling of Stratholme
    ...
    tmpCategories[98] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(284), nil)); -- Trial of the Champion
    ...
    tmpCategories[99] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(280), nil)); -- The Forge of Souls
    ...
    tmpCategories[100] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(278), nil)); -- Pit of Saron
    ...
    tmpCategories[101] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(276), nil)); -- Halls of Reflection
    ...
    tmpCategories[85] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15271), nil)); -- Raids
    ...
    tmpCategories[102] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(753), nil)); -- Vault of Archavon
    tmpCategories[85]:AddCategory(tmpCategories[102]);
    tmpCategories[103] = InsertAndReturn(categories, achievementCategory:New(GetDifficultyInfo(3), nil)); -- Vault of Archavon 10
    ...
    tmpCategories[104] = InsertAndReturn(categories, achievementCategory:New(GetDifficultyInfo(4), nil)); -- Vault of Archavon 25
    ...
    tmpCategories[105] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(754), nil)); -- Naxxramas
    tmpCategories[85]:AddCategory(tmpCategories[105]);
    tmpCategories[106] = InsertAndReturn(categories, achievementCategory:New(GetDifficultyInfo(3), nil)); -- Naxxramas 10
    ...
    tmpCategories[107] = InsertAndReturn(categories, achievementCategory:New(GetDifficultyInfo(4), nil)); -- Naxxramas 25
    ...
    tmpCategories[108] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(755), nil)); -- The Obsidian Sanctum
    tmpCategories[85]:AddCategory(tmpCategories[108]);
    tmpCategories[109] = InsertAndReturn(categories, achievementCategory:New(GetDifficultyInfo(3), nil)); -- The Obsidian Sanctum 10
    ...
    tmpCategories[110] = InsertAndReturn(categories, achievementCategory:New(GetDifficultyInfo(4), nil)); -- The Obsidian Sanctum 25
    ...
    tmpCategories[111] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(756), nil)); -- The Eye of Eternity
    tmpCategories[85]:AddCategory(tmpCategories[111]);
    tmpCategories[112] = InsertAndReturn(categories, achievementCategory:New(GetDifficultyInfo(3), nil)); -- The Eye of Eternity 10
    ...
    tmpCategories[113] = InsertAndReturn(categories, achievementCategory:New(GetDifficultyInfo(4), nil)); -- The Eye of Eternity 25
    ...
    tmpCategories[114] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(759), nil)); -- Ulduar
    ...
    tmpCategories[115] = InsertAndReturn(categories, achievementCategory:New(GetDifficultyInfo(3) .. " (" .. GetCategoryInfo(15234) .. ")", nil)); -- Ulduar 10
    ...
    tmpCategories[116] = InsertAndReturn(categories, achievementCategory:New(GetDifficultyInfo(4) .. " (" .. GetCategoryInfo(15234) .. ")", nil)); -- Ulduar 25
    ...
    tmpCategories[117] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(757), nil)); -- Trial of the Crusader
    tmpCategories[85]:AddCategory(tmpCategories[117]);
    tmpCategories[118] = InsertAndReturn(categories, achievementCategory:New(GetDifficultyInfo(3), nil)); -- Trial of the Crusader 10
    ...
    tmpCategories[119] = InsertAndReturn(categories, achievementCategory:New(GetDifficultyInfo(4), nil)); -- Trial of the Crusader 25
    ...
    tmpCategories[120] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(760), nil)); -- Onyxia's Lair
    tmpCategories[85]:AddCategory(tmpCategories[120]);
    tmpCategories[121] = InsertAndReturn(categories, achievementCategory:New(GetDifficultyInfo(3), nil)); -- Onyxia's Lair 10
    ...
    tmpCategories[122] = InsertAndReturn(categories, achievementCategory:New(GetDifficultyInfo(4), nil)); -- Onyxia's Lair 25
    ...
    tmpCategories[123] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(758), nil)); -- Icecrown Citadel
    tmpCategories[85]:AddCategory(tmpCategories[123]);
    tmpCategories[124] = InsertAndReturn(categories, achievementCategory:New(GetDifficultyInfo(3), nil)); -- Icecrown Citadel 10
    ...
    tmpCategories[125] = InsertAndReturn(categories, achievementCategory:New(GetDifficultyInfo(4), nil)); -- Icecrown Citadel 25
    ...
    tmpCategories[126] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(761), nil)); -- The Ruby Sanctum
    tmpCategories[85]:AddCategory(tmpCategories[126]);
    tmpCategories[127] = InsertAndReturn(categories, achievementCategory:New(GetDifficultyInfo(3), nil)); -- The Ruby Sanctum 10
    ...
    tmpCategories[128] = InsertAndReturn(categories, achievementCategory:New(GetDifficultyInfo(4), nil)); -- The Ruby Sanctum 25
    ...
    tmpCategories[129] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15072), nil)); -- Cataclysm
    tmpCategories[130] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15272), nil)); -- Dungeons
    ...
    tmpCategories[132] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(66), nil)); -- Blackrock Caverns
    ...
    tmpCategories[133] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(65), nil)); -- Throne of the Tides
    ...
    tmpCategories[134] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(67), nil)); -- The Stonecore
    ...
    tmpCategories[135] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(68), nil)); -- The Vortex Pinnacle
    ...
    tmpCategories[136] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(71), nil)); -- Grim Batol
    ...
    tmpCategories[137] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(70), nil)); -- Halls of Origination
    ...
    tmpCategories[138] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(69), nil)); -- Lost City of the Tol'vir
    ...
    tmpCategories[139] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(63), nil)); -- Deadmines
    ...
    tmpCategories[140] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(64), nil)); -- Shadowfang Keep
    ...
    tmpCategories[141] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(76), nil)); -- Zul'Gurub
    ...
    tmpCategories[142] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(77), nil)); -- Zul'Aman
    ...
    tmpCategories[143] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(184), nil)); -- End Time
    ...
    tmpCategories[144] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(185), nil)); -- Well of Eternity
    ...
    tmpCategories[145] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(186), nil)); -- Hour of Twilight
    ...
    tmpCategories[131] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15271), nil)); -- Raids
    ...
    tmpCategories[146] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(75), nil)); -- Baradin Hold
    ...
    tmpCategories[147] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(73), nil)); -- Blackwing Descent
    ...
    tmpCategories[148] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(72), nil)); -- The Bastion of Twilight
    ...
    tmpCategories[149] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(74), nil)); -- Throne of the Four Winds
    ...
    tmpCategories[150] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(78), nil)); -- Firelands
    ...
    tmpCategories[151] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(187), nil)); -- Dragon Soul
    ...
    tmpCategories[189] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15164), nil)); -- Mists of Pandaria
    tmpCategories[190] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15272), nil)); -- Dungeons
    ...
    tmpCategories[193] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(313), nil)); -- Temple of the Jade Serpent
    ...
    tmpCategories[194] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(302), nil)); -- Stormstout Brewery
    ...
    tmpCategories[195] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(321), nil)); -- Mogu'shan Palace
    ...
    tmpCategories[196] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(312), nil)); -- Shado-Pan Monastery
    ...
    tmpCategories[197] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(303), nil)); -- Gate of the Setting Sun
    ...
    tmpCategories[198] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(324), nil)); -- Siege of Niuzao Temple
    ...
    tmpCategories[199] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(311), nil)); -- Scarlet Halls
    ...
    tmpCategories[200] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(316), nil)); -- Scarlet Monastery
    ...
    tmpCategories[201] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(246), nil)); -- Scholomance
    ...
    tmpCategories[191] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15271), nil)); -- Raids
    ...
    tmpCategories[202] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(317), nil)); -- Mogu'shan Vaults
    ...
    tmpCategories[203] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(330), nil)); -- Heart of Fear
    ...
    tmpCategories[204] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(320), nil)); -- Terrace of Endless Spring
    ...
    tmpCategories[205] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(362), nil)); -- Throne of Thunder
    ...
    tmpCategories[206] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(369), nil)); -- Siege of Orgrimmar
    ...
    tmpCategories[192] = InsertAndReturn(categories, achievementCategory:New(addon.L["Scenarios"], nil)); -- Scenarios
    ...
    tmpCategories[207] = InsertAndReturn(categories, achievementCategory:New(GetLFGDungeonInfo(517), nil)); -- A Brewing Storm
    ...
    tmpCategories[208] = InsertAndReturn(categories, achievementCategory:New(GetLFGDungeonInfo(511), nil)); -- Arena of Annihilation
    ...
    tmpCategories[209] = InsertAndReturn(categories, achievementCategory:New(GetLFGDungeonInfo(539), nil)); -- Brewmoon Festival
    ...
    tmpCategories[210] = InsertAndReturn(categories, achievementCategory:New(GetLFGDungeonInfo(504), nil)); -- Crypt of Forgotten Kings
    ...
    tmpCategories[211] = InsertAndReturn(categories, achievementCategory:New(GetLFGDungeonInfo(492), nil)); -- Greenstone Village
    ...
    tmpCategories[212] = InsertAndReturn(categories, achievementCategory:New(GetLFGDungeonInfo(566), nil)); -- Theramore's Fall
    ...
    tmpCategories[213] = InsertAndReturn(categories, achievementCategory:New(GetLFGDungeonInfo(499), nil)); -- Unga Ingoo
    ...
    tmpCategories[214] = InsertAndReturn(categories, achievementCategory:New(GetLFGDungeonInfo(593), nil)); -- Assault on Zan'vess
    ...
    tmpCategories[215] = InsertAndReturn(categories, achievementCategory:New(GetLFGDungeonInfo(616), nil)); -- Dagger in the Dark
    ...
    tmpCategories[216] = InsertAndReturn(categories, achievementCategory:New(GetLFGDungeonInfo(590), nil)); -- Lion's Landing
    ...
    tmpCategories[218] = InsertAndReturn(categories, achievementCategory:New(GetLFGDungeonInfo(595), nil)); -- Domination Point
    ...
    tmpCategories[219] = InsertAndReturn(categories, achievementCategory:New(GetLFGDungeonInfo(655), nil)); -- Battle on the High Seas
    ...
    tmpCategories[220] = InsertAndReturn(categories, achievementCategory:New(GetLFGDungeonInfo(646), nil)); -- Blood in the Snow
    ...
    tmpCategories[221] = InsertAndReturn(categories, achievementCategory:New(GetLFGDungeonInfo(647), nil)); -- Dark Heart of Pandaria
    ...
    tmpCategories[222] = InsertAndReturn(categories, achievementCategory:New(GetLFGDungeonInfo(649), nil)); -- The Secrets of Ragefire
    ...
    tmpCategories[223] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15233), nil)); -- Warlords of Dreanor
    tmpCategories[224] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15272), nil)); -- Dungeons
    ...
    tmpCategories[226] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(385), nil)); -- Bloodmaul Slag Mines
    ...
    tmpCategories[227] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(558), nil)); -- Iron Docks
    ...
    tmpCategories[228] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(547), nil)); -- Auchindoun
    ...
    tmpCategories[229] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(476), nil)); -- Skyreach
    ...
    tmpCategories[230] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(536), nil)); -- Grimrail Depot
    ...
    tmpCategories[231] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(556), nil)); -- The Everbloom
    ...
    tmpCategories[232] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(537), nil)); -- Shadowmoon Burial Grounds
    ...
    tmpCategories[233] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(559), nil)); -- Upper Blackrock Spire
    ...
    tmpCategories[225] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15271), nil)); -- Raids
    ...
    tmpCategories[234] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(477), nil)); -- Highmaul
    ...
    tmpCategories[235] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(457), nil)); -- Blackrock Foundry
    ...
    tmpCategories[236] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(669), nil)); -- Hellfire Citadel
    ...
    tmpCategories[432] = InsertAndReturn(categories, achievementCategory:New(addon.L["Garrison"], nil)); -- Garrison
    tmpCategories[223]:AddCategory(tmpCategories[432]);
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9100, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9101, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9545, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9546, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9210, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9132, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(8933, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9901, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9928, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9828, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9912, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(10015, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9897, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9914, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(10016, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9125, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9126, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9128, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9095, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9096, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9097, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9094, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9487, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9076, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9077, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9080, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9078, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9429, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9099, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9098, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9405, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9406, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9407, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9450, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9565, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9451, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9452, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9468, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9495, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9497, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9498, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9499, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9538, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9526, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9539, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9705, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9540, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9706, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9527, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9703, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9516, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9517, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9518, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9519, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9520, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9521, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9522, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9509, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9510, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9511, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9512, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9513, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9514, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9515, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9639, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9508, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9738, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9107, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9108, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9109, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9494, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9110, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9111, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9129, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9130, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9131, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9211, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9212, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9213, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9243, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9152, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9167, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9543, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9244, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9205, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9206, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9203, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9204, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9207, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9208, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9162, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9164, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9165, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9826, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9209, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9827, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9181, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9858, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9133, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9134, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9138, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9139, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9140, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9141, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9142, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9143, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9145, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9524, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9146, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9523, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9147, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9150, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9900, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9246, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9248, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9630, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9255, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9631, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9264, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9265, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(10177, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(10169, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(10168, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(10170, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(10172, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(10173, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(10255, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(10275, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(10276, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(10174, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(10156, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(10154, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(10159, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(10160, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(10161, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(10155, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(10162, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(10163, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(10017, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(10036, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(10164, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(10165, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(10166, nil, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(10256, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(10167, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(10258, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(10307, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9640, nil, nil, false, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9641, nil, nil, false, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(9642, nil, nil, false, nil, nil)));
    tmpCategories[432]:AddAchievement(InsertAndReturn(achievements, achievement:New(10021, nil, nil, false, nil, nil)));
    tmpCategories[237] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15258), nil)); -- Legion
    tmpCategories[381] = InsertAndReturn(categories, achievementCategory:New(addon.L["Zones"], nil)); -- Zones
    tmpCategories[237]:AddCategory(tmpCategories[381]);
    tmpCategories[396] = InsertAndReturn(categories, achievementCategory:New(C_Map.GetMapInfo(619).name, nil)); -- Broken Isles
    tmpCategories[381]:AddCategory(tmpCategories[396]);
    tmpCategories[397] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[398] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), nil)); -- Exploration
    ...
    tmpCategories[413] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15270), nil)); -- PvP
    ...
    tmpCategories[414] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), nil)); -- Reputation
    ...
    tmpCategories[382] = InsertAndReturn(categories, achievementCategory:New(C_Map.GetMapInfo(626).name, nil)); -- Dalaran
    tmpCategories[381]:AddCategory(tmpCategories[382]);
    tmpCategories[383] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[405] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), nil)); -- Exploration
    ...
    tmpCategories[384] = InsertAndReturn(categories, achievementCategory:New(C_Map.GetMapInfo(630).name, nil)); -- Azsuna
    tmpCategories[381]:AddCategory(tmpCategories[384]);
    tmpCategories[385] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[399] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), nil)); -- Exploration
    ...
    tmpCategories[412] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15270), nil)); -- PvP
    ...
    tmpCategories[387] = InsertAndReturn(categories, achievementCategory:New(C_Map.GetMapInfo(641).name, nil)); -- Val'sharah
    tmpCategories[381]:AddCategory(tmpCategories[387]);
    tmpCategories[391] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[400] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), nil)); -- Exploration
    ...
    tmpCategories[411] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15270), nil)); -- PvP
    ...
    tmpCategories[388] = InsertAndReturn(categories, achievementCategory:New(C_Map.GetMapInfo(650).name, nil)); -- Highmountain
    tmpCategories[381]:AddCategory(tmpCategories[388]);
    tmpCategories[392] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[401] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), nil)); -- Exploration
    ...
    tmpCategories[410] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15270), nil)); -- PvP
    ...
    tmpCategories[416] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), nil)); -- Reputation
    ...
    tmpCategories[386] = InsertAndReturn(categories, achievementCategory:New(C_Map.GetMapInfo(634).name, nil)); -- Stormheim
    tmpCategories[381]:AddCategory(tmpCategories[386]);
    tmpCategories[390] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[402] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), nil)); -- Exploration
    ...
    tmpCategories[409] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15270), nil)); -- PvP
    ...
    tmpCategories[389] = InsertAndReturn(categories, achievementCategory:New(C_Map.GetMapInfo(680).name, nil)); -- Suramar
    tmpCategories[381]:AddCategory(tmpCategories[389]);
    tmpCategories[393] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[403] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), nil)); -- Exploration
    ...
    tmpCategories[415] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), nil)); -- Reputation
    ...
    tmpCategories[394] = InsertAndReturn(categories, achievementCategory:New(C_Map.GetMapInfo(646).name, nil)); -- Broken Shore
    tmpCategories[381]:AddCategory(tmpCategories[394]);
    tmpCategories[395] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[404] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), nil)); -- Exploration
    ...
    tmpCategories[417] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), nil)); -- Reputation
    ...
    tmpCategories[406] = InsertAndReturn(categories, achievementCategory:New(C_Map.GetMapInfo(905).name, nil)); -- Argus
    tmpCategories[381]:AddCategory(tmpCategories[406]);
    tmpCategories[407] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[408] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), nil)); -- Exploration
    ...
    tmpCategories[418] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), nil)); -- Reputation
    ...
    tmpCategories[238] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15272), nil)); -- Dungeons
    ...
    tmpCategories[240] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(716), nil)); -- Eye of Azshara
    ...
    tmpCategories[241] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(762), nil)); -- Darkheart Thicket
    ...
    tmpCategories[242] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(721), nil)); -- Halls of Valor
    ...
    tmpCategories[243] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(767), nil)); -- Neltharions Lair
    ...
    tmpCategories[244] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(777), nil)); -- Assault on Violet Hold
    ...
    tmpCategories[245] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(707), nil)); -- Vault of the Wardens
    ...
    tmpCategories[246] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(740), nil)); -- Black Rook Hold
    ...
    tmpCategories[247] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(727), nil)); -- Maw of Souls
    ...
    tmpCategories[248] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(726), nil)); -- The Arcway
    ...
    tmpCategories[249] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(800), nil)); -- Court of Stars
    ...
    tmpCategories[250] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(860), nil)); -- Return to Karazhan
    ...
    tmpCategories[251] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(900), nil)); -- Cathedral of Eternal Night
    ...
    tmpCategories[252] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(945), nil)); -- Seat of the Triumvirate
    ...
    tmpCategories[239] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15271), nil)); -- Raids
    ...
    tmpCategories[253] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(768), nil)); -- The Emerald Nightmare
    ...
    tmpCategories[254] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(786), nil)); -- The Nighthold
    ...
    tmpCategories[255] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(861), nil)); -- Trial of Valor
    ...
    tmpCategories[256] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(875), nil)); -- Tomb of Sargeras
    ...
    tmpCategories[257] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(946), nil)); -- Antorus, the Burning Throne
    ...
    tmpCategories[430] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15117), nil)); -- Pet Battles
    ...
    tmpCategories[429] = InsertAndReturn(categories, achievementCategory:New(addon.L["Class Hall"], nil)); -- Class Hall
    ...
    tmpCategories[429]:AddAchievement(InsertAndReturn(achievements, achievement:New(11218, nil, nil, false, nil, nil)));
    tmpCategories[258] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15305), nil)); -- Battle for Azeroth
    tmpCategories[259] = InsertAndReturn(categories, achievementCategory:New(addon.L["Zones"], nil)); -- Zones
    tmpCategories[258]:AddCategory(tmpCategories[259]);
    tmpCategories[271] = InsertAndReturn(categories, achievementCategory:New(C_Map.GetMapInfo(876).name .. " & " .. C_Map.GetMapInfo(875).name, nil)); -- Kul Tiras & Zandalar
    tmpCategories[259]:AddCategory(tmpCategories[271]);
    tmpCategories[272] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[273] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), nil)); -- Exploration
    ...
    tmpCategories[274] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15270), nil)); -- PvP
    ...
    tmpCategories[275] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), nil)); -- Reputation
    ...
    tmpCategories[281] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), {895, 1161, 1169, 1171, 1172, 1184, 1185})); -- Quests
    ...
    tmpCategories[281]:AddAchievement(InsertAndReturn(achievements, achievement:New(13060, faction.Alliance, nil, nil, nil, nil)));
    ...
    tmpCategories[278] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), {895, 1161, 1169, 1171, 1172, 1184, 1185})); -- Exploration
    ...
    tmpCategories[279] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15270), {895, 1161, 1169, 1171, 1172, 1184, 1185})); -- PvP
    ...
    tmpCategories[280] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), {895, 1161, 1169, 1171, 1172, 1184, 1185})); -- Reputation
    ...
    tmpCategories[283] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), {896, 1045})); -- Quests
    ...
    tmpCategories[284] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), {896, 1045})); -- Exploration
    ...
    tmpCategories[285] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15270), {896, 1045})); -- PvP
    ...
    tmpCategories[286] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), {896, 1045})); -- Reputation
    ...
    tmpCategories[288] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), {942, 1179, 1180, 1182, 1183})); -- Quests
    ...
    tmpCategories[289] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), {942, 1179, 1180, 1182, 1183})); -- Exploration
    ...
    tmpCategories[290] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15270), {942, 1179, 1180, 1182, 1183})); -- PvP
    ...
    tmpCategories[291] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), {942, 1179, 1180, 1182, 1183})); -- Reputation
    ...
    tmpCategories[293] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), {862, 1165, 1173, 1174, 1176, 1177})); -- Quests
    ...
    tmpCategories[294] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), {862, 1165, 1173, 1174, 1176, 1177})); -- Exploration
    ...
    tmpCategories[295] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15270), {862, 1165, 1173, 1174, 1176, 1177})); -- PvP
    ...
    tmpCategories[296] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), {862, 1165, 1173, 1174, 1176, 1177})); -- Reputation
    ...
    tmpCategories[298] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), {863})); -- Quests
    ...
    tmpCategories[299] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), {863})); -- Exploration
    ...
    tmpCategories[300] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15270), {863})); -- PvP
    ...
    tmpCategories[301] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), {863})); -- Reputation
    ...
    tmpCategories[302] = InsertAndReturn(categories, achievementCategory:New(C_Map.GetMapInfo(864).name, {864})); -- Voldun
    tmpCategories[259]:AddCategory(tmpCategories[302]);
    tmpCategories[303] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), {864})); -- Quests
    ...
    tmpCategories[304] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), {864})); -- Exploration
    ...
    tmpCategories[305] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15270), {864})); -- PvP
    ...
    tmpCategories[306] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), {864})); -- Reputation
    ...
    tmpCategories[308] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), {1462})); -- Quests
    ...
    tmpCategories[309] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), {1462})); -- Exploration
    ...
    tmpCategories[310] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15270), {1462})); -- PvP
    ...
    tmpCategories[311] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), {1462})); -- Reputation
    ...
    tmpCategories[313] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), {1355, 1528})); -- Quests
    ...
    tmpCategories[314] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), {1355, 1528})); -- Exploration
    ...
    tmpCategories[315] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15270), {1355, 1528})); -- PvP
    ...
    tmpCategories[316] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), {1355, 1528})); -- Reputation
    ...
    tmpCategories[317] = InsertAndReturn(categories, achievementCategory:New(C_Map.GetMapInfo(1530).name, {1530, 391, 392, 393, 394, 395, 396})); -- Vale of Eternal Blossoms
    tmpCategories[259]:AddCategory(tmpCategories[317]);
    tmpCategories[318] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), {1530, 391, 392, 393, 394, 395, 396})); -- Quests
    ...
    tmpCategories[447] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), {1530, 391, 392, 393, 394, 395, 396})); -- Exploration
    ...
    tmpCategories[321] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), {1530, 391, 392, 393, 394, 395, 396})); -- Reputation
    ...
    tmpCategories[323] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), {1527})); -- Quests
    ...
    tmpCategories[448] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), {1527})); -- Exploration
    ...
    tmpCategories[324] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), {1527})); -- Reputation
    ...
    tmpCategories[325] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15272), nil)); -- Dungeons
    ...
    tmpCategories[326] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15271), nil)); -- Raids
    ...
    tmpCategories[338] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(1031), {1148, 1149, 1150, 1151, 1152, 1153, 1154, 1155, 1381, 1382})); -- Uldir
    ...
    tmpCategories[340] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(1177), {1345, 1346, 1363})); -- Crucible of Storms
    ...
    tmpCategories[341] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(1179), {1512, 1513, 1514, 1515, 1516, 1517, 1518, 1519, 1520})); -- The Eternal Palace
    ...
    tmpCategories[343] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15117), nil)); -- Pet Battles
    ...
    tmpCategories[425] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15307), nil)); -- Island Expeditions
    ...
    tmpCategories[436]:AddAchievement(InsertAndReturn(achievements, achievement:New(12590, nil, nil, nil, nil, nil)));
    tmpCategories[436]:AddAchievement(InsertAndReturn(achievements, achievement:New(12589, nil, nil, nil, nil, nil)));
    tmpCategories[436]:AddAchievement(InsertAndReturn(achievements, achievement:New(12591, nil, nil, nil, nil, nil)));
    tmpCategories[436]:AddAchievement(InsertAndReturn(achievements, achievement:New(12592, nil, nil, nil, nil, nil)));
    ...
    tmpCategories[437]:AddAchievement(InsertAndReturn(achievements, achievement:New(13095, nil, nil, nil, nil, nil)));
    tmpCategories[437]:AddAchievement(InsertAndReturn(achievements, achievement:New(13096, nil, nil, nil, nil, nil)));
    tmpCategories[437]:AddAchievement(InsertAndReturn(achievements, achievement:New(13097, nil, nil, nil, nil, nil)));
    tmpCategories[437]:AddAchievement(InsertAndReturn(achievements, achievement:New(13098, nil, nil, nil, nil, nil)));
    ...
    tmpCategories[438]:AddAchievement(InsertAndReturn(achievements, achievement:New(13103, nil, nil, nil, nil, nil)));
    tmpCategories[438]:AddAchievement(InsertAndReturn(achievements, achievement:New(13104, nil, nil, nil, nil, nil)));
    tmpCategories[438]:AddAchievement(InsertAndReturn(achievements, achievement:New(13105, nil, nil, nil, nil, nil)));
    tmpCategories[438]:AddAchievement(InsertAndReturn(achievements, achievement:New(13106, nil, nil, nil, nil, nil)));
    ...
    tmpCategories[439]:AddAchievement(InsertAndReturn(achievements, achievement:New(13099, nil, nil, nil, nil, nil)));
    tmpCategories[439]:AddAchievement(InsertAndReturn(achievements, achievement:New(13100, nil, nil, nil, nil, nil)));
    tmpCategories[439]:AddAchievement(InsertAndReturn(achievements, achievement:New(13101, nil, nil, nil, nil, nil)));
    tmpCategories[439]:AddAchievement(InsertAndReturn(achievements, achievement:New(13102, nil, nil, nil, nil, nil)));
    ...
    tmpCategories[440]:AddAchievement(InsertAndReturn(achievements, achievement:New(13111, nil, nil, nil, nil, nil)));
    tmpCategories[440]:AddAchievement(InsertAndReturn(achievements, achievement:New(13112, nil, nil, nil, nil, nil)));
    tmpCategories[440]:AddAchievement(InsertAndReturn(achievements, achievement:New(13113, nil, nil, nil, nil, nil)));
    tmpCategories[440]:AddAchievement(InsertAndReturn(achievements, achievement:New(13114, nil, nil, nil, nil, nil)));
    ...
    tmpCategories[441]:AddAchievement(InsertAndReturn(achievements, achievement:New(13107, nil, nil, nil, nil, nil)));
    tmpCategories[441]:AddAchievement(InsertAndReturn(achievements, achievement:New(13108, nil, nil, nil, nil, nil)));
    tmpCategories[441]:AddAchievement(InsertAndReturn(achievements, achievement:New(13109, nil, nil, nil, nil, nil)));
    tmpCategories[441]:AddAchievement(InsertAndReturn(achievements, achievement:New(13110, nil, nil, nil, nil, nil)));
    ...
    tmpCategories[442]:AddAchievement(InsertAndReturn(achievements, achievement:New(13119, nil, nil, nil, nil, nil)));
    tmpCategories[442]:AddAchievement(InsertAndReturn(achievements, achievement:New(13118, nil, nil, nil, nil, nil)));
    tmpCategories[442]:AddAchievement(InsertAndReturn(achievements, achievement:New(13116, nil, nil, nil, nil, nil)));
    tmpCategories[442]:AddAchievement(InsertAndReturn(achievements, achievement:New(13115, nil, nil, nil, nil, nil)));
    ...
    tmpCategories[443]:AddAchievement(InsertAndReturn(achievements, achievement:New(13389, nil, nil, nil, nil, nil)));
    tmpCategories[443]:AddAchievement(InsertAndReturn(achievements, achievement:New(13394, nil, nil, nil, nil, nil)));
    tmpCategories[443]:AddAchievement(InsertAndReturn(achievements, achievement:New(13395, nil, nil, nil, nil, nil)));
    tmpCategories[443]:AddAchievement(InsertAndReturn(achievements, achievement:New(13399, nil, nil, nil, nil, nil)));
    ...
    tmpCategories[444]:AddAchievement(InsertAndReturn(achievements, achievement:New(13396, nil, nil, nil, nil, nil)));
    tmpCategories[444]:AddAchievement(InsertAndReturn(achievements, achievement:New(13397, nil, nil, nil, nil, nil)));
    tmpCategories[444]:AddAchievement(InsertAndReturn(achievements, achievement:New(13398, nil, nil, nil, nil, nil)));
    tmpCategories[444]:AddAchievement(InsertAndReturn(achievements, achievement:New(13400, nil, nil, nil, nil, nil)));
    ...
    tmpCategories[445]:AddAchievement(InsertAndReturn(achievements, achievement:New(13577, nil, nil, nil, nil, nil)));
    tmpCategories[445]:AddAchievement(InsertAndReturn(achievements, achievement:New(13578, nil, nil, nil, nil, nil)));
    tmpCategories[445]:AddAchievement(InsertAndReturn(achievements, achievement:New(13579, nil, nil, nil, nil, nil)));
    tmpCategories[445]:AddAchievement(InsertAndReturn(achievements, achievement:New(13580, nil, nil, nil, nil, nil)));
    ...
    tmpCategories[446]:AddAchievement(InsertAndReturn(achievements, achievement:New(13581, nil, nil, nil, nil, nil)));
    tmpCategories[446]:AddAchievement(InsertAndReturn(achievements, achievement:New(13582, nil, nil, nil, nil, nil)));
    tmpCategories[446]:AddAchievement(InsertAndReturn(achievements, achievement:New(13583, nil, nil, nil, nil, nil)));
    tmpCategories[446]:AddAchievement(InsertAndReturn(achievements, achievement:New(13584, nil, nil, nil, nil, nil)));
    tmpCategories[426] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15308), nil)); -- War Effort
    ...
    tmpCategories[434] = InsertAndReturn(categories, achievementCategory:New(GetLFGDungeonInfo(1615), nil)); -- Battle for Stromgarde
    tmpCategories[426]:AddCategory(tmpCategories[434]);
    tmpCategories[434]:AddAchievement(InsertAndReturn(achievements, achievement:New(12873, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[434]:AddAchievement(InsertAndReturn(achievements, achievement:New(13735, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[434]:AddAchievement(InsertAndReturn(achievements, achievement:New(12881, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[434]:AddAchievement(InsertAndReturn(achievements, achievement:New(13737, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[434]:AddAchievement(InsertAndReturn(achievements, achievement:New(12877, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[434]:AddAchievement(InsertAndReturn(achievements, achievement:New(12876, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[434]:AddAchievement(InsertAndReturn(achievements, achievement:New(12888, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[434]:AddAchievement(InsertAndReturn(achievements, achievement:New(12889, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[434]:AddAchievement(InsertAndReturn(achievements, achievement:New(12878, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[434]:AddAchievement(InsertAndReturn(achievements, achievement:New(12884, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[434]:AddAchievement(InsertAndReturn(achievements, achievement:New(12879, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[434]:AddAchievement(InsertAndReturn(achievements, achievement:New(13738, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[434]:AddAchievement(InsertAndReturn(achievements, achievement:New(12886, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[434]:AddAchievement(InsertAndReturn(achievements, achievement:New(13739, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[434]:AddAchievement(InsertAndReturn(achievements, achievement:New(12874, nil, nil, nil, nil, nil)));
    tmpCategories[435] = InsertAndReturn(categories, achievementCategory:New(GetLFGDungeonInfo(1901), nil)); -- The Battle for Darkshore
    tmpCategories[426]:AddCategory(tmpCategories[435]);
    tmpCategories[435]:AddAchievement(InsertAndReturn(achievements, achievement:New(13296, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[435]:AddAchievement(InsertAndReturn(achievements, achievement:New(14149, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[435]:AddAchievement(InsertAndReturn(achievements, achievement:New(13297, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[435]:AddAchievement(InsertAndReturn(achievements, achievement:New(14150, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[435]:AddAchievement(InsertAndReturn(achievements, achievement:New(13301, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[435]:AddAchievement(InsertAndReturn(achievements, achievement:New(13306, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[435]:AddAchievement(InsertAndReturn(achievements, achievement:New(13302, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[435]:AddAchievement(InsertAndReturn(achievements, achievement:New(13305, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[435]:AddAchievement(InsertAndReturn(achievements, achievement:New(13307, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[435]:AddAchievement(InsertAndReturn(achievements, achievement:New(13308, faction.Alliance, nil, nil, nil, nil)));
    tmpCategories[435]:AddAchievement(InsertAndReturn(achievements, achievement:New(13309, faction.Horde, nil, nil, nil, nil)));
    tmpCategories[435]:AddAchievement(InsertAndReturn(achievements, achievement:New(13310, faction.Alliance, nil, nil, nil, nil)));
    ...
    tmpCategories[428] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15426), {1021, 1473, 1604, 1469, 1470})); -- Visions of N'Zoth	
    ...
    tmpCategories[6] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15439), nil)); -- Shadowlands
    tmpCategories[344] = InsertAndReturn(categories, achievementCategory:New(addon.L["Zones"], nil)); -- Zones
    ...
    tmpCategories[345] = InsertAndReturn(categories, achievementCategory:New(C_Map.GetMapInfo(1533).name, {1533, 1569, 1813})); -- Bastion
    tmpCategories[344]:AddCategory(tmpCategories[345]);
    tmpCategories[346] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), {1533, 1569, 1813})); -- Quests
    ...
    tmpCategories[347] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), {1533, 1569, 1813})); -- Exploration
    ...
    tmpCategories[348] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15270), {1533, 1569, 1813})); -- PvP
    ...
    tmpCategories[349] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), {1533, 1569, 1813})); -- Reputation
    ...
    tmpCategories[350] = InsertAndReturn(categories, achievementCategory:New(C_Map.GetMapInfo(1536).name, {1536, 1689, 1741, 1814})); -- Maldraxxus
    tmpCategories[344]:AddCategory(tmpCategories[350]);
    tmpCategories[351] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), {1536, 1689, 1741, 1814})); -- Quests
    ...
    tmpCategories[352] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), {1536, 1689, 1741, 1814})); -- Exploration
    ...
    tmpCategories[353] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15270), {1536, 1689, 1741, 1814})); -- PvP
    ...
    tmpCategories[354] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), {1536, 1689, 1741, 1814})); -- Reputation
    ...
    tmpCategories[355] = InsertAndReturn(categories, achievementCategory:New(C_Map.GetMapInfo(1565).name, {1565, 1603, 1643, 1709, 1739, 1740})); -- Ardenweald
    tmpCategories[344]:AddCategory(tmpCategories[355]);
    tmpCategories[356] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), {1565, 1603, 1643, 1709, 1739, 1740})); -- Quests
    ...
    tmpCategories[357] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), {1565, 1603, 1643, 1709, 1739, 1740})); -- Exploration
    ...
    tmpCategories[358] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15270), {1565, 1603, 1643, 1709, 1739, 1740})); -- PvP
    ...
    tmpCategories[359] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), {1565, 1603, 1643, 1709, 1739, 1740})); -- Reputation
    ...
    tmpCategories[360] = InsertAndReturn(categories, achievementCategory:New(C_Map.GetMapInfo(1525).name, {1525, 1688, 1734, 1738, 1742})); -- Revendreth
    tmpCategories[344]:AddCategory(tmpCategories[360]);
    tmpCategories[361] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), {1525, 1688, 1734, 1738, 1742})); -- Quests
    ...
    tmpCategories[362] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), {1525, 1688, 1734, 1738, 1742})); -- Exploration
    ...
    tmpCategories[363] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15270), {1525, 1688, 1734, 1738, 1742})); -- PvP
    ...
    tmpCategories[364] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), {1525, 1688, 1734, 1738, 1742})); -- Reputation
    ...
    tmpCategories[365] = InsertAndReturn(categories, achievementCategory:New(C_Map.GetMapInfo(1543).name, {1543, 1648})); -- The Maw
    tmpCategories[344]:AddCategory(tmpCategories[365]);
    tmpCategories[366] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), {1543, 1648})); -- Quests
    ...
    tmpCategories[367] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), {1543, 1648})); -- Exploration
    ...
    tmpCategories[368] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), {1543, 1648})); -- Reputation
    ...
    tmpCategories[369] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15272), nil)); -- Dungeons
    ...
    tmpCategories[377] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(1188), {1677, 1678, 1679, 1680, 1917})); -- De Other Side
    ...
    tmpCategories[370] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15271), nil)); -- Raids
    ...
    tmpCategories[379] = InsertAndReturn(categories, achievementCategory:New(EJ_GetInstanceInfo(1190), {1735, 1744, 1745, 1746, 1747, 1748, 1750, 1755})); -- Castle Nathria
    ...
    tmpCategories[380] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15117), nil)); -- Pet Battles
    ...
    tmpCategories[419] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15441), nil)); -- Covenant Sanctums
    ...
    tmpCategories[423] = InsertAndReturn(categories, achievementCategory:New(C_Covenants.GetCovenantData(1).name, {1707, 1708})); -- Kyrian
    ...
    tmpCategories[421] = InsertAndReturn(categories, achievementCategory:New(C_Covenants.GetCovenantData(2).name, {1699, 1700})); -- Venthyr
    ...
    tmpCategories[422] = InsertAndReturn(categories, achievementCategory:New(C_Covenants.GetCovenantData(3).name, {1701, 1702, 1703})); -- Night Fae
    ...
    tmpCategories[420] = InsertAndReturn(categories, achievementCategory:New(C_Covenants.GetCovenantData(4).name, {1698})); -- Necrolord
