-- [[ Exported at 2021-03-24 23-21-22 ]] --
...
function exportedData.Load(categories, achievements)
    ...
    tmpCategories[449] = InsertAndReturn(categories, achievementCategory:New(addon.L["Zones"], nil)); -- Zones
    tmpCategories[223]:AddCategory(tmpCategories[449]);
    tmpCategories[486] = InsertAndReturn(categories, achievementCategory:New(C_Map.GetMapInfo(572).name, nil)); -- Draenor
    tmpCategories[449]:AddCategory(tmpCategories[486]);
    tmpCategories[487] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[488] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), nil)); -- Exploration
    ...
    tmpCategories[489] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), nil)); -- Reputation
    ...
    tmpCategories[457] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[458] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), nil)); -- Exploration
    ...
    tmpCategories[460] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), nil)); -- Reputation
    ...
    tmpCategories[461] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[462] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), nil)); -- Exploration
    ...
    tmpCategories[464] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), nil)); -- Reputation
    ...
    tmpCategories[465] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[466] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), nil)); -- Exploration
    ...
    tmpCategories[468] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), nil)); -- Reputation
    ...
    tmpCategories[469] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[470] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), nil)); -- Exploration
    ...
    tmpCategories[472] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), nil)); -- Reputation
    ...
    tmpCategories[473] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[474] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), nil)); -- Exploration
    ...
    tmpCategories[476] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), nil)); -- Reputation
    ...
    tmpCategories[477] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[478] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), nil)); -- Exploration
    ...
    tmpCategories[480] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), nil)); -- Reputation
    ...
    tmpCategories[481] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[482] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), nil)); -- Exploration
    ...
    tmpCategories[484] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), nil)); -- Reputation
    ...
    tmpCategories[485] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[281] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[278] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), nil)); -- Exploration
    ...
    tmpCategories[279] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15270), nil)); -- PvP
    ...
    tmpCategories[280] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), nil)); -- Reputation
    ...
    tmpCategories[283] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[284] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), nil)); -- Exploration
    ...
    tmpCategories[285] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15270), nil)); -- PvP
    ...
    tmpCategories[286] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), nil)); -- Reputation
    ...
    tmpCategories[288] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[289] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), nil)); -- Exploration
    ...
    tmpCategories[290] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15270), nil)); -- PvP
    ...
    tmpCategories[291] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), nil)); -- Reputation
    ...
    tmpCategories[293] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[294] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), nil)); -- Exploration
    ...
    tmpCategories[295] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15270), nil)); -- PvP
    ...
    tmpCategories[296] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), nil)); -- Reputation
    ...
    tmpCategories[298] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[299] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), nil)); -- Exploration
    ...
    tmpCategories[300] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15270), nil)); -- PvP
    ...
    tmpCategories[301] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), nil)); -- Reputation
    ...
    tmpCategories[303] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[304] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), nil)); -- Exploration
    ...
    tmpCategories[305] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15270), nil)); -- PvP
    ...
    tmpCategories[306] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), nil)); -- Reputation
    ...
    tmpCategories[308] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[309] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), nil)); -- Exploration
    ...
    tmpCategories[310] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15270), nil)); -- PvP
    ...
    tmpCategories[311] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), nil)); -- Reputation
    ...
    tmpCategories[313] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[314] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), nil)); -- Exploration
    ...
    tmpCategories[315] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15270), nil)); -- PvP
    ...
    tmpCategories[316] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), nil)); -- Reputation
    ...
    tmpCategories[318] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[447] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), nil)); -- Exploration
    ...
    tmpCategories[321] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), nil)); -- Reputation
    ...
    tmpCategories[323] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[448] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), nil)); -- Exploration
    ...
    tmpCategories[324] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), nil)); -- Reputation
    ...
    tmpCategories[346] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[347] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), nil)); -- Exploration
    ...
    tmpCategories[348] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15270), nil)); -- PvP
    ...
    tmpCategories[349] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), nil)); -- Reputation
    ...
    tmpCategories[351] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[352] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), nil)); -- Exploration
    ...
    tmpCategories[353] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15270), nil)); -- PvP
    ...
    tmpCategories[354] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), nil)); -- Reputation
    ...
    tmpCategories[356] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[357] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), nil)); -- Exploration
    ...
    tmpCategories[358] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15270), nil)); -- PvP
    ...
    tmpCategories[359] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), nil)); -- Reputation
    ...
    tmpCategories[361] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[362] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), nil)); -- Exploration
    ...
    tmpCategories[363] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15270), nil)); -- PvP
    ...
    tmpCategories[364] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), nil)); -- Reputation
    ...
    tmpCategories[366] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15447), nil)); -- Quests
    ...
    tmpCategories[367] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(97), nil)); -- Exploration
    ...
    tmpCategories[368] = InsertAndReturn(categories, achievementCategory:New(GetCategoryInfo(15273), nil)); -- Reputation
