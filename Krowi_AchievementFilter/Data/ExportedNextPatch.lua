...
function nextPatch.Load(achievements)
    ...
    addon.NextPatchAchievements[15077] = {15077, "Shadowlands Keystone Conqueror: Season Two", 0, "Attain a Mythic+ Rating of at least X during Shadowlands Season Two.", 133120, 618858, "Title Reward: TBD"};
    addon.NextPatchAchievements[15078] = {15078, "Shadowlands Keystone Master: Season Two", 0, "Attain a Mythic+ Rating of at least X during Shadowlands Season Two.", 133120, 618859, "Mount Reward: TBD"};
    ...
    addon.NextPatchAchievements[15075] = {15075, "Infiltrators", 0, "Defeat each of the following rare encounters in Torghast, Tower of the Damned:", 0, 1413862, ""};
    addon.NextPatchAchievements[15076] = {15076, "The Box of Many Things", 0, "Obtain the Box of Many Things in Torghast, Tower of the Damned.", 0, 4094821, ""};
    addon.NextPatchAchievements[15091] = {15091, "A Taste of Perfection", 0, "Achieve a Flawless run in Torghast, Tower of the damned.", 0, 603532, ""};
    addon.NextPatchAchievements[15089] = {15089, "Flawless Master", 0, "Achieve a Flawless run on layer 12 in each wing of Torghast, Tower of the Damned.", 0, 3731620, "Mount Reward: Mawsworn Charger"};
    addon.NextPatchAchievements[15081] = {15081, "Flawless: Skoldus Hall", 0, "Achieve a Flawless run on layer 12 in Skoldus Hall.", 0, 3555135, ""};
    addon.NextPatchAchievements[15082] = {15082, "Flawless: Fracture Chambers", 0, "Achieve a Flawless run on layer 12 in Fracture Chambers.", 0, 3592448, ""};
    addon.NextPatchAchievements[15084] = {15084, "Flawless: The Soulforges", 0, "Achieve a Flawless run on layer 12 in The Soulforges.", 0, 467102, ""};
    addon.NextPatchAchievements[15083] = {15083, "Flawless: Coldheart Interstitia", 0, "Achieve a Flawless run on layer 12 in Coldheart Interstitia.", 0, 3552748, ""};
    addon.NextPatchAchievements[15087] = {15087, "Flawless: Mort'regar", 0, "Achieve a Flawless run on layer 12 in Mort'regar.", 0, 3586456, ""};
    addon.NextPatchAchievements[15088] = {15088, "Flawless: Upper Reaches", 0, "Achieve a Flawless run on layer 12 in Upper Reaches.", 0, 522867, ""};
    addon.NextPatchAchievements[15080] = {15080, "So Blessed", 0, "Research rank 3 of Blessing of the Ancients in the Box of Many Things.", 0, 135769, ""};
    addon.NextPatchAchievements[15079] = {15079, "Many, Many Things", 0, "Research every talent in the Box of Many Things.", 0, 4037125, "Pet Reward: Mord'al Eveningstar"};
    addon.NextPatchAchievements[15092] = {15092, "Master of Torment", 0, "Complete the achievements listed below:", 0, 132344, ""};
    addon.NextPatchAchievements[15093] = {15093, "Avenge Me!", 0, "Slay an elite enemy with 10 stacks of Vengeance in Torghast, Tower of the Damned.", 0, 458971, ""};
    addon.NextPatchAchievements[15094] = {15094, "Rampage", 0, "Maintain maximum stacks of Rampaging for 30 consecutive seconds in Torghast, Tower of the Damned.", 0, 1035053, ""};
    addon.NextPatchAchievements[15095] = {15095, "No Doubt", 0, "Defeat a boss without killing or interrupting any of the Mawsworn Doubtcaller's spells while the Torment \"Backup\" is active in Torghast, Tower of the Damned.", 0, 458226, ""};
    addon.NextPatchAchievements[15096] = {15096, "Crowd Pleaser", 0, "Be under the effects of Claustrophobia for 30 consecutive seconds in Torghast, Tower of the Damned.", 0, 1387356, ""};
end
