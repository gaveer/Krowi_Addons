-- [[ Exported at 2021-05-13 18-41-26 ]] --
...
function nextPatch.Load(achievements)
    ...
    addon.NextPatchAchievements[15065] = {15065, "Eye Wish You Were Here", 10, "Use the Scavenged S.E.L.F.I.E. Camera to take a picture of the Eye of the Jailer and the entire raid after it has cast Immediate Extermination, then defeat the Eye of the Jailer on Normal difficulty or higher.", 0, 1109100, ""};
    ...
    addon.NextPatchAchievements[15105] = {15105, "Off Brand", 10, "Defeat Soulrender Dormazain without allowing Brand of Torment to damage Mawsworn in the Sanctum of Domination on Normal difficulty or higher.", 0, 1100175, ""};
    addon.NextPatchAchievements[15108] = {15108, "Together Forever", 10, "Defeat Kel'Thuzad after thawing the Remnant's heart on Normal difficulty or higher.", 0, 1390944, ""};
