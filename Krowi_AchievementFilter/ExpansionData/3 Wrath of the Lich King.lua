...
tinsert(KrowiAF.Data, expansion);
    ...
    -- Dungeons
        ...
        dungeons:AddAchievementIDs({2136}); -- Overarching achievements

        -- 3.0
            dungeon = dungeons:AddChild(KrowiAF.AchievementCategory:NewEJ(285)); -- Utgarde Keep
            dungeon:AddAchievementIDs({}); -- Glory of the Hero
        ...
        -- 3.3
            ...
            dungeon = dungeons:AddChild(KrowiAF.AchievementCategory:NewEJ(66)); -- Halls of Reflection
            dungeon:AddAchievementIDs({}); -- Glory of the Hero
            dungeon:AddAchievementIDs({}); -- Defeat the bosses in X