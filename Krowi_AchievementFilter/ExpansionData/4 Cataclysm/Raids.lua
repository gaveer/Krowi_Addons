...
function raids.BaradinHold.Load(catDungeons)
	local raid = catDungeons:AddCatInstanceInfo(75);
    raid:AddAchievementIDs(5416, 6045 --[[4.2]], 6108 --[[4.3]]); -- Defeat the bosses in X
end

raids.TheBastionOfTwilight = {} -- 4.0
function raids.TheBastionOfTwilight.Load(catDungeons)
	local raid = catDungeons:AddCatInstanceInfo(72);
...
function raids.ThroneOfTheFourWinds.Load(catDungeons)
	local raid = catDungeons:AddCatInstanceInfo(74);
...
raids.Firelands = {} -- 4.2
function raids.Firelands.Load(catDungeons)
	local raid = catDungeons:AddCatInstanceInfo(78);
...
function raids.DragonSoul.Load(catDungeons)
	local raid = catDungeons:AddCatInstanceInfo(187);
