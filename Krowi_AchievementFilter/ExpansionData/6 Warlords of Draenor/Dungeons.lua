...
dungeons = Xpack_WoD:AddCategory(KrowiAF.AchievementSubsection.Dungeons);
...
-- 6.0
    ...
    dungeon:AddAchievementFOSIDs({8875, 8876, 8877, 8878, 9620}); -- Challenge mode (Unobtainable)
    ...
    dungeon:AddAchievementFOSIDs({8997, 8998, 8999, 9000, 9621}); -- Challenge mode (Unobtainable)
    ...
    dungeon:AddAchievementFOSIDs({8879, 8880, 8881, 8882, 9622}); -- Challenge mode (Unobtainable)
    ...
    dungeon:AddAchievementFOSIDs({8871, 8872, 8873, 8874, 9623}); -- Challenge mode (Unobtainable)
    ...
    dungeon:AddAchievementFOSIDs({8887, 8888, 8889, 8890, 9625}); -- Challenge mode (Unobtainable)
    ...
    dungeon:AddAchievementFOSIDs({9001, 9002, 9003, 9004, 9624}); -- Challenge mode (Unobtainable)
    ...
    dungeon:AddAchievementFOSIDs({8883, 8884, 8885, 8886, 9626}); -- Challenge mode (Unobtainable)
    ...
    dungeon:AddAchievementFOSIDs({8891, 8892, 8893, 8894, 9627}); -- Challenge mode (Unobtainable)