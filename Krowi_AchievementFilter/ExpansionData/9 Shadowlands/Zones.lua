...
function zones.Bastion.Load(catZones)
    ...
    zone:AddCatExploration():AddAchievementIDs(14303, 14307, 14311, 14339, 14734, 14767, 14768);
...
function zones.Ardenweald.Load(catZones)
    ...
    zone:AddCatExploration():AddAchievementIDs(14304, 14309, 14313, 14353, 14774, 14788, 14779);
...
function zones.TheMaw.Load(catZones)
    ...
    zone:AddCatExploration():AddAchievementIDs(14663, 14894, 14895, 14658, 14659, 14660, 14738, 14742, 14743, 14744, 14745, 14746, 14747, 14761);
...
function zones.Load(expansion)
    ...
    catZones:AddAchievementIDs(14515, 14516); -- PvP
