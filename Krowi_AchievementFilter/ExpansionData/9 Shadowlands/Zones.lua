...
-- 9.0
    zone = zones:AddSubsection(as.ZoneName, 1533); -- Bastion
    ...
    zone = zones:AddSubsection(as.ZoneName, 1536); -- Maldraxxus
    ...
    zone = zones:AddSubsection(as.ZoneName, 1565); -- Ardenweald
    ...
    zone = zones:AddSubsection(as.ZoneName, 1525); -- Revendreth
    ...
    zone = zones:AddSubsection(as.ZoneName, 1543); -- The Maw
    ...
    -- zone = zones:AddSubsection(as.ZoneName, 1671); -- Oribos
