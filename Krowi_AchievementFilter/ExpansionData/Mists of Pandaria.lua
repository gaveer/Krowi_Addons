...
-- Expansion
expansion = KrowiAF.AchievementCategory:New(AF_CATEGORY_MOP);
tinsert(KrowiAF.Data, expansion);

    -- Raids
    raids = expansion:AddChild(KrowiAF.AchievementCategory:New(AF_CATEGORY_RAIDS));
    raids:AddAchievementIDs({6932, 8124, 8454}); -- Glory of the ...

        -- 5.0
            raid = raids:AddChild(KrowiAF.AchievementCategory:New(AF_CATEGORY_XPACK_MOP_RAID_MSV)); -- Mogu'shan Vaults
            ...
            raid = raids:AddChild(KrowiAF.AchievementCategory:New(AF_CATEGORY_XPACK_MOP_RAID_HoF)); -- Heart of Fear
            ...
            raid = raids:AddChild(KrowiAF.AchievementCategory:New(AF_CATEGORY_XPACK_MOP_RAID_ToES)); -- Terrace of Endless Spring
        ...
        -- 5.2
            raid = raids:AddChild(KrowiAF.AchievementCategory:New(AF_CATEGORY_XPACK_MOP_RAID_ToT)); -- Throne of Thunder
        ...
        -- 5.4
            raid = raids:AddChild(KrowiAF.AchievementCategory:New(AF_CATEGORY_XPACK_MOP_RAID_SoO)); -- Siege of Orgrimmar
