                ...
                TimeDisplay = {
                    ...
                    args = {
                        Line1 = {
                            ...
                            get = function ()
                                return addon.Options.db.EventAlert.TimeDisplay.Line1;
                            end,
                            set = function(_, value)
                                if addon.Options.db.EventAlert.TimeDisplay.Line1 == value then
                                    return;
                                end;
                                ...
                                diagnostics.Debug(addon.L["Line"] .. " 1" .. ": " .. tostring(addon.Options.db.EventAlert.TimeDisplay.Line1));
                            end
                        },                            
                        Line2 = {
                            name = addon.L["Line"] .. " 2",
                            ...
                            get = function ()
                                return addon.Options.db.EventAlert.TimeDisplay.Line2;
                            end,
                            set = function(_, value)
                                if addon.Options.db.EventAlert.TimeDisplay.Line2 == value then
                                    return;
                                end;
                                ...
                                diagnostics.Debug(addon.L["Line"] .. " 1" .. ": " .. tostring(addon.Options.db.EventAlert.TimeDisplay.Line2));
                            end
                        },
                    }
                },
                    ...
                    args = {
                        ...
                        StartTimeAndEndTimePresets = {
                            ...
                            set = function(_, value)
                                ...
                                diagnostics.Debug(addon.L["Presets"] .. ": " .. tostring(addon.Options.db.EventAlert.DateTimeFormat.StartTimeAndEndTime));
                            end
                        },
                        StartTimeAndEndTimeCustom = {
                            ...
                            order = 2.2,
                            get = function ()
                                return addon.Options.db.EventAlert.DateTimeFormat.StartTimeAndEndTime;
                            end,
                            set = function(_, value)
                                if addon.Options.db.EventAlert.DateTimeFormat.StartTimeAndEndTime == value then
                                    return;
                                end;
                                ...
                                diagnostics.Debug(addon.L["Custom"] .. ": " .. tostring(addon.Options.db.EventAlert.DateTimeFormat.StartTimeAndEndTime));
                            end
                        },
                        -- TimeLeft = {
                        --     name = addon.L["Time Left"],
                        --     type = "header",
                        --     order = 3
                        -- },
                        -- TimeLeftPresets = {
                        ...
                        --     width = 1.5,
                        --     order = 4.1,
                        --     values = timeLeftDateTimeValues,
                        --     get = function ()
                        --         for i, format in next, timeLeftDateTimeFormats do
                        --             if format == addon.Options.db.EventAlert.DateTimeFormat.TimeLeft then
                        --                 return i;
                        --             end
                        --         end
                        --         return #timeLeftDateTimeFormats;
                        --     end,
                        --     set = function(_, value)
                        --         local custom = LibStub("AceConfigRegistry-3.0"):GetOptionsTable(addon.MetaData.Title, "cmd", "KROWIAF-0.0").args.EventAlert.args.DateTimeFormat.args.TimeLeftCustom; -- cmd and KROWIAF-0.0 are just to make the function work
                        --         custom.set(nil, timeLeftDateTimeFormats[value]);

                        --         diagnostics.Debug(addon.L["Presets"] .. ": " .. tostring(addon.Options.db.EventAlert.DateTimeFormat.TimeLeft));
                        --     end
                        -- },
                        -- TimeLeftCustom = {
                        --     name = addon.L["Custom"],
                        ...
                        --     order = 4.2,
                        --     get = function ()
                        --         return addon.Options.db.EventAlert.DateTimeFormat.TimeLeft;
                        --     end,
                        --     set = function(_, value)
                        --         if addon.Options.db.EventAlert.DateTimeFormat.TimeLeft == value then
                        --             return;
                        --         end;

                        --         addon.Options.db.EventAlert.DateTimeFormat.TimeLeft = value;

                        --         for _, sideButton in next, addon.GUI.SideButtons do
                        --             sideButton:UpdateRuntime();
                        --         end

                        --         diagnostics.Debug(addon.L["Custom"] .. ": " .. tostring(addon.Options.db.EventAlert.DateTimeFormat.TimeLeft));
                        --     end
                        -- },
...
function options.InjectDefaults(table, tableName, ...)
    local destTable = defaults.profile;
    for i = 1, select("#", ...), 1 do
...
function options.InjectOptionsTable(table, tableName, ...)
    local destTable = optionsTable.args;
    for i = 1, select("#", ...), 1 do
        destTable = destTable[select(i, ...)];
    end
    destTable[tableName] = table;
