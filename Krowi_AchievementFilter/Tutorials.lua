        ...
        {   -- 6
            ...
            text = GetTitle(addon.L["FT_FILTER_TITLE"]) ..
                            addon.ReplaceVars{addon.L["FT_FILTER_DESC"],
                                            completed = AF_COLOR_YELLOW .. addon.L["F_COMPLETED"] .. AF_COLOR_END,
                                            notCompleted = AF_COLOR_YELLOW .. addon.L["F_NOT_COMPLETED"] .. AF_COLOR_END,
                                            obtainable = AF_COLOR_YELLOW .. addon.L["F_OBTAINABLE"] .. AF_COLOR_END,
                                            notObtainable = AF_COLOR_YELLOW .. addon.L["F_NOT_OBTAINABLE"] .. AF_COLOR_END,
                                            faction = addon.L["F_FACTION"],
                                            neutral = AF_COLOR_YELLOW .. addon.L["F_NEUTRAL"] .. AF_COLOR_END,
                                            alliance = AF_COLOR_YELLOW .. addon.L["F_ALLIANCE"] .. AF_COLOR_END,
                                            horde = AF_COLOR_YELLOW .. addon.L["F_HORDE"] .. AF_COLOR_END,
                                            noSorting = AF_COLOR_YELLOW .. addon.L["F_DEFAULT"] .. AF_COLOR_END,
                                            sortByName = AF_COLOR_YELLOW .. addon.L["F_NAME"] .. AF_COLOR_END,
