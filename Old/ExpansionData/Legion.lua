...
-- Raids
Xpack_Legion_Raids = Xpack_Legion:AddChild(TreeObject:New("Raids"));

-- 7.0
Xpack_Legion_Raid_EN = Xpack_Legion_Raids:AddChild(TreeObjectWithAchievements:New("Emerald Nightmare"));
...
Xpack_Legion_Raid_EN:AddAchievement(11194, AchievementType.FoS, false);  -- Feats of Strength (Unobtainable)
Xpack_Legion_Raid_EN:AddAchievement(11191, AchievementType.FoS, false);  -- Feats of Strength (Unobtainable)
-- Xpack_Legion_Raid_NH = Xpack_Legion_Raids:AddChild(TreeObjectWithAchievements:New(""));
...
-- Xpack_Legion_Raid_NH:AddAchievement(, AchievementType.FoS, false);  -- Feats of Strength (Unobtainable)
-- Xpack_Legion_Raid_NH:AddAchievement(, AchievementType.FoS, false);  -- Feats of Strength (Unobtainable)

-- -- 7.1
-- Xpack_Legion_Raid_ToV = Xpack_Legion_Raids:AddChild(TreeObjectWithAchievements:New(""));
...
-- Xpack_Legion_Raid_ToV:AddAchievement(, AchievementType.FoS, false);  -- Feats of Strength (Unobtainable)
-- Xpack_Legion_Raid_ToV:AddAchievement(, AchievementType.FoS, false);  -- Feats of Strength (Unobtainable)

-- -- 7.2
-- Xpack_Legion_Raid_ToS = Xpack_Legion_Raids:AddChild(TreeObjectWithAchievements:New(""));
...
-- Xpack_Legion_Raid_ToS:AddAchievement(, AchievementType.FoS, false);  -- Feats of Strength (Unobtainable)
-- Xpack_Legion_Raid_ToS:AddAchievement(, AchievementType.FoS, false);  -- Feats of Strength (Unobtainable)

-- -- 7.3
-- Xpack_Legion_Raid_Antorus = Xpack_Legion_Raids:AddChild(TreeObjectWithAchievements:New(""));
...
-- Xpack_Legion_Raid_Antorus:AddAchievement(, AchievementType.FoS, false);  -- Feats of Strength (Unobtainable)
-- Xpack_Legion_Raid_Antorus:AddAchievement(, AchievementType.FoS, false);  -- Feats of Strength (Unobtainable)